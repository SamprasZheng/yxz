...
MSBAI received a $1.2 million Direct-to-Phase II SBIR award from the DoD CDAO (competitively selected by the Office of the Secretary of Defense; Air Force Digital Transformation Office executing). The 18-month contract targets scaling OrbitGuard to monitor 20,000+ resident space objects at ≤2-minute latency, against an operational backdrop where **active spacecraft are projected to surpass 17,000 by 2026** (press-kit framing). The planned model upgrades are **Graph-JEPA + Patch Time-Series Transformers** with MARL threat assessment, targeting ≥95% operational accuracy. It builds on a prior Space Force contract (**FA864923P1191**, AFRL/RVSX "DRAGON Army"). See [[sources/msbai-orbitguard-dod-contract-2025]] for full details.

**Status (re-fact-checked 2026-09-21):** still no new publicly-announced award beyond the Sept-2025 $1.2M CDAO Direct-to-Phase-II SBIR; the 18-month period of performance runs into ~Q1-2027. The only indexed public artifacts remain the Sept-2025 award coverage and the [AMOS 2025 poster](https://amostech.com/TechnicalPapers/2025/Poster/Grosvenor.pdf) ("Hierarchical Neuro-Symbolic AI for Autonomous Spacecraft Maneuvering and Anomaly Detection", Grosvenor) — no 2026 award, priced round, or new program surfaced. The most recent public milestone remains the SDA TAP Lab Apollo Demo Day (2025-08-13, below). By contrast, the *training/rehearsal* wing of the same US archetype escalated sharply in 2026 — [[entities/slingshot-aerospace|Slingshot]]'s $69.2M USSF OTTI award for the MENTAT/Talos agent (2026-07-15) dwarfs MSBAI's SBIR, underlining that MSBAI is a *small-business live-SDA* specialist rather than a scaled prime. See [[synthesis/llm-satellite-operations-six-region]] §2.
