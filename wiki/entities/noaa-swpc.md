...
- **2026-08 (through 17th)** — quiet-to-minor declining-phase baseline: **G1** storms 2–3 Aug (late-July CME tails), Kp 4 warning 14 Aug, a CME arriving late 17 Aug forecast to give G1 (chance G2); no G4+ all month — the "rare-but-severe punctuating quiet" signature of the descent
- **2026-07-29 → 08-01** — **Geomagnetic storm watches, "up to G3 (Strong)", extended into 1 August** — but **observed only G1–G2**, *under*-performing the forecast by ~2 levels: multiple CMEs from 27–28 July + an M1.9/filament CME (N20W67, partial halo) 30 July merging into complex ejecta (a "**cannibal CME**"); an **S1 (Minor) radiation storm** accompanied it on 30 July. The mirror image of the 3–4 July *over*-performance — a clean illustration of the two-sided severity-forecast error (mechanism in [[concepts/cme-propagation-geoeffectiveness]])
- **2026-02-01/04** — **X8.1 (Strong) flare** from Region 4366 (2357 UTC 01 Feb), the **3rd-strongest flare of SC25**; R3 radio blackout over the S. Pacific / E. Australia / NZ; the giant AR was ≈half the area of the 1859 Carrington sunspot. Its CME only **glanced** Earth on 04 Feb → a minor **G1** storm (Kp 5) — SWPC's textbook *flare ≠ storm* case that solar-max flare hazard persists deep into the declining phase ([SWPC](https://www.spaceweather.gov/news/update-x81-strong-flare-region-4366))
