...
**Six-region note:** that base-model switch is geopolitically loaded. A **US** open-weight lab fine-tuning on Alibaba's **Chinese** Qwen-3 base reflects the central finding of [[synthesis/open-weight-llm-agent-stack-six-region]] — by 2026 the strongest open-weight *bases* increasingly come from China (Qwen, DeepSeek V4 Pro, and the AA-Intelligence-Index open-weight leaders — Z.AI's **GLM-5.3** (open-weight #1, ≈45 on Index v4.3, weights shipped 2026-08-28) narrowly ahead of Moonshot's **Kimi K3** (≈44; the largest open-weight model ever at 2.8T params)), so even US labs build on them. *(Both sit ~8 pts under the closed US frontier — Claude Fable 5.1 / GPT-6 Astra = 53 on v4.3 — after a Sept-2026 closed-frontier generation reopened the gap; see [[synthesis/open-weight-llm-agent-stack-six-region]].)* The Hermes lineage is thus a **US-alignment-layer on a Chinese-and-American base mix**, distributed for a US (NVIDIA) hackathon — the open-weight commons in one artifact.
