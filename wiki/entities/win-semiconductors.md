...
- **~2040+ / 100-year (labelled scenario):** compound semiconductors remain the unavoidable physics layer for high-power/high-frequency RF and optical front-ends — a permanent toll booth like the rest of the cluster. The structural risk is **GaN-IDM in-sourcing** (US/Europe primes captive lines — the concrete 2023–2025 example is [[entities/macom]] absorbing Wolfspeed's RF GaN-on-SiC line and taking full control of the RTP fab in 2025-07) and **China's sovereign-by-sanction GaN build-out** eroding merchant-foundry share, not technology obsolescence ([[synthesis/phased-array-rf-frontend-supply-chain]], [[synthesis/orbital-data-center-six-region]]). The risk sharpened in 2026 into a **two-substrate** threat (see the GaN-on-SiC-vs-GaN-on-Si split on [[synthesis/phased-array-rf-frontend-supply-chain]]): the *cheaper* GaN-on-Si end (2× lower wafer cost on 8-inch Si, CMOS-class fabs, 5G/mmWave volume — where Chinese 0.1 µm 24–30 GHz lines are aimed) is the more contestable, while GaN-on-SiC's thermal-headroom moat is stickier for the high-EIRP/space tier Win actually feeds.
