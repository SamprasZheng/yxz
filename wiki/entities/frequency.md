...
## Adoption signal (verified 2026-08-19)

- **MeWe migration:** Amplica Labs + MeWe moved **500,000+ MeWe users** onto Frequency (milestone announced Jan 2024), then crossed the **"over 1 million users"** mark (PR, Aug 2024); the more precise reading of that count is **~1.3 M MeWe users migrated, ~600 K of them with their full social graphs**. The original 2023 announcement framed a path to MeWe's ~20 M-user base, so penetration of MeWe's own base remains partial. MeWe appointed **Carlos Betancourt** CEO in 2025 to continue the Web3 push. Still among the largest Web2→Web3 social migrations to date. ([Frequency — over 1 M users PR](https://www.prnewswire.com/news-releases/frequency-blockchain-celebrates-over-1-million-users-in-partnership-with-mewe-302227534.html))
...
- **Scale context (the humbling comparison, now two-sided):** the *federated/off-chain* rival **AT Protocol / Bluesky** reached **~46 M registered accounts (mid-2026)** — Bluesky does not officially disclose MAU, but third-party trackers show active users that **peaked ~27.5 M (Feb 2026) and then roughly halved to a mobile ~10.4 M MAU (June 2026, −27 % YoY, Similarweb via TechCrunch)** as Bluesky pivots from the flagship app to the wider AT-Protocol "atmosphere." That is still **~1–2 orders of magnitude above** Frequency's DSNP-identity count, but the humbling comparison now cuts *both* ways: chain-anchoring lost the adoption race, yet the federated winner's *app* engagement is itself **contracting**, not compounding — so "user-owned social wins by federation" is a weaker claim in Aug-2026 than it looked in H1. See the architecture-split table on [[synthesis/digital-democracy-user-owned-social-six-region]].
