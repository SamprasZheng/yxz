...
## Adoption signal (verified 2026-07-31)
...
- **Scale context (the humbling comparison):** the *federated/off-chain* rival **AT Protocol / Bluesky** reached **~43 M registered accounts (mid-2026)** — Bluesky does not officially disclose MAU, but third-party trackers put active users at ~15–27.5 M (H1-2026), i.e. **~1–2 orders of magnitude above** Frequency's DSNP-identity count. Chain-anchoring buys a stronger portability guarantee but has *not* won the adoption race; the market picked the lighter DID/federation model. See the architecture-split table on [[synthesis/digital-democracy-user-owned-social-six-region]].
