...
- [[synthesis/daily-trader-2026-06-07]] — First-run stub (2026-06-07): trader pipeline not yet implemented + network allowlist blocks yfinance; seed watchlist 15 tickers (NVDA/AAPL/TSLA/MSFT/AMD/GOOGL/META/AMZN/SMCI/PLTR/AVGO/ARM/CRM/INTC/QCOM); FOM formula defined (0.4×confidence + 0.3×norm_sigma + 0.2×hit_rate + 0.1×news_mom); remediation checklist for future runs
