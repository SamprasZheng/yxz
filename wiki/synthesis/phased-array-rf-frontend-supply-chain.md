...
| 2. Power amplifier | T/R front-end power | **GaN-on-SiC** (high-power/thermal) **+ GaN-on-Si** (cost-volume) > GaAs > LDMOS | Foundry + thermal; capital heavy (substrate split → *§ below*) |
...
## Layer 2 gets a second axis — the GaN substrate split (GaN-on-SiC vs GaN-on-Si) (加深探究, verified 2026-09-19)

Layer 2 in the stack table is written "GaN-on-SiC (>GaAs >LDMOS)," but by 2026 the GaN PA layer is really **two substrate platforms with a sharp cost/thermal division of labour** — the layer-down mechanism the map had collapsed into one row:

| Substrate | Cost / wafer | Thermal | Where it wins | Where it loses |
|---|---|---|---|---|
| **GaN-on-SiC** | High (SiC substrate) | **Best** — SiC ~3× the thermal conductivity of Si; 2–4 W/mm at Ka-band (26–40 GHz) | High-power, high-EIRP, thermally-stressed: **radar T/R, high-EIRP SATCOM, space-grade** | Cost per PA in high-volume terminals |
| **GaN-on-Si** | **~2× lower** — standard 8-inch (200 mm) Si wafers on CMOS-class lines | Worse (Si ~1/3 the SiC thermal conductivity) → power-density-limited | **Cost-dominated mmWave volume**: 5G massive-MIMO, cost-sensitive flat-panel terminals; 0.1 µm GaN-on-Si at 24–30 GHz in active development (notably by Chinese institutions targeting large-volume 5G) | Peak power density / thermal headroom |

The strategic reading: the **same GaN-IDM in-sourcing move** now splits by end-market. **[[entities/macom|MACOM]] explicitly runs *both* platforms** — GaN-on-SiC (PURE CARBIDE®) for the A&D/high-EIRP tier and GaN-on-Si for cost-driven volume — as does the broader US/Europe merchant tier; the substrate is chosen per application, not per vendor. This *widens* the Layer-2 competitive surface: China's sovereign-by-sanction build-out can attack the **GaN-on-Si volume** end (cheap Si wafers, CMOS-class fabs, 5G-scale demand) without matching SiC-substrate quality, exactly where merchant-foundry margin is thinnest. It also sharpens the [[entities/win-semiconductors]] risk note — the 100-year "GaN-IDM in-sourcing" threat is not one threat but two, and the cheaper (GaN-on-Si) one is the more contestable. Current MACOM product anchors (SATShow Week 2026-03 + IMS 2026-06): **CMPA2H3B025D** 25 W GaN-on-SiC Ka-band SATCOM PA (27–31 GHz, bare die + Cu flange) and L/S-band T/R front-ends (1 W, >40 dB gain, >40% efficiency, PURE CARBIDE® GaN). On the Layer-1 beamformer side, Qorvo added **AWMF-0247** for *shared-aperture* flat-panel arrays (LEO/airborne, power-constrained) above the AWMF-0240 (Rx)/0241 (Tx) Ku-band pair, which reached **volume production Q1 2026** (−25% Tx / −14% Rx DC power).
...
- If GaN-on-Si (cheap 8-inch Si wafers) reaches Ka-band power density and reliability parity with GaN-on-SiC at high volume → the SiC-substrate thermal-headroom moat erodes at the mmWave-volume end, and the merchant-foundry margin most exposed to China's sovereign build-out is the first to compress (watch MACOM/Qorvo GaN-on-Si mmWave qualification and Chinese 0.1 µm 24–30 GHz GaN-on-Si volume ramps).
...
## Sources (accessed 2026-05-31; US-consolidation + market re-verify 2026-08-30; GaN substrate axis + 2026 product anchors 2026-09-19)

- **GaN substrate bifurcation (GaN-on-SiC vs GaN-on-Si), 2026-09-19 verification:** GaN-on-Si ~2× lower wafer cost on standard 8-inch Si but Si ~1/3 the thermal conductivity of SiC → power-density-limited, targeting cost-driven mmWave/massive-MIMO volume (incl. Chinese 0.1 µm 24–30 GHz GaN-on-Si); GaN-on-SiC 2–4 W/mm at Ka-band, the high-power/thermal default — [PatSnap Eureka — GaN-on-SiC vs GaN-on-Si RF power amplifiers](https://www.patsnap.com/resources/blog/rd-blog/gan-on-sic-vs-gan-on-si-rf-power-amplifiers-patsnap-eureka/); [PatSnap Eureka — GaN RF PA technology 2026](https://www.patsnap.com/resources/blog/rd-blog/gan-rf-power-amplifier-technology-2026-patsnap-eureka/); [Microchip — GaN-on-SiC SWaP-C for SATCOM/A&D](https://www.microchip.com/en-us/about/media-center/blog/2025/gan-on-sic-power-amplifiers-providing-swap-c-benefits)
- **MACOM 2026 SATCOM/A&D products (runs both GaN-on-SiC + GaN-on-Si):** CMPA2H3B025D 25 W Ka-band SATCOM PA 27–31 GHz + L/S-band T/R (1 W, >40 dB gain, >40% eff, PURE CARBIDE® GaN); shown SATShow Week 2026 (Mar 24–26, DC) + IMS 2026 (Jun 9–11, Boston) — [MACOM IMS 2026 SATCOM product announcements](https://www.macom.com/updates/news/2026/macom-ims-2026-product-announcements-for-satellite-communication); [MACOM SATShow Week 2026](https://macom.gcs-web.com/news-releases/news-release-details/macoms-microwave-and-optical-comprehensive-solutions-display/)
- **Qorvo 2026 beamformer additions:** AWMF-0247 shared-aperture flat-panel beamformer (LEO/airborne, power-constrained); AWMF-0240 (Rx)/0241 (Tx) Ku-band pair volume production Q1 2026 (−25% Tx / −14% Rx DC power) — [Qorvo Ku-band beamformers (SatNews 2025-03)](https://news.satnews.com/2025/03/31/qorvo-launches-ku-band-beamformers-for-high-performance-satcom-terminals/); [everythingRF — Qorvo Ku-band SATCOM beamformer ICs](https://www.everythingrf.com/news/details/19793-qorvo-introduces-new-silicon-ku-band-satcom-beamformer-ics-for-phased-array-terminals)
