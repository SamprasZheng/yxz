...
| 1024-QAM | **≈1.8%** (now a **ratified** optional 3GPP DL modulation — see correction below) | calibration-and-converter-limited regime; demands phase noise <~0.3° RMS + sub-0.1 dB / sub-0.5° IQ calibration |

> **Corrected 2026-08-24** (prior text: "1024-QAM ~2%, *not yet* a ratified 3GPP BS limit"): 1024-QAM downlink is now a **ratified optional modulation in 3GPP Release 17** for the base station, with a reported EVM ceiling of **≈1.8%** (secondary technical sources; the exact TS 38.104 Table 6.5.2.2-1 cell was not primary-verified this pass — flagged, not asserted). The structural point is unchanged and now sharper: the highest ratified order has pushed the ceiling *below* 2%, i.e. squarely into the converter-linearity/phase-noise-limited regime where sub-layers A and C bind before the PA does.
