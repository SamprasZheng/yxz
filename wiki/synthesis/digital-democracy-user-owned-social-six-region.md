...
concepts:
  - "[[concepts/plurality]]"
  - "[[concepts/ai-mediated-deliberation]]"
  - "[[concepts/dsnp]]"
...
| **B. Plural collective decision-making** | deliberation, voting, public-goods funding | [[concepts/plurality]]; Quadratic Voting/Funding ([[entities/glen-weyl]]); vTaiwan/Polis/Join ([[entities/audrey-tang]]); Gitcoin QF (→ multi-mechanism "Gitcoin 3.0" 2025); **[[concepts/ai-mediated-deliberation]]** (Habermas Machine / Talk to the City) |
...
| **Japan** | consumes global platforms; Astar/Polkadot dev community | **Team Mirai** (Takahiro Anno, explicitly [[concepts/plurality]]-inspired, runs on AI "broadlistening" / [[concepts/ai-mediated-deliberation]]) — **1 Councillors seat 2025 → 11 Representatives seats 2026-02 (3.97 M / 6.9%)**; "Digital Democracy 2030"; Digital Agency | My Number card | **tech-led, now a parliamentary force** — Plurality scaled *inside* a legislature |
...
> **Update — re-verified 2026-09-08 (Axis-B deepening: Team Mirai scales from beachhead to bloc; Gitcoin goes multi-mechanism; AI-mediated deliberation split out as a new dimension).** The 2026-08-19 pass refreshed Axis A (social graph) + the PoP dependency; this pass works the previously-frozen **Axis B (plural collective decision-making)**.
> - **Japan's Team Mirai went from beachhead to bloc.** The [[concepts/plurality]]-inspired party ([[entities/audrey-tang|Takahiro Anno]]) won **11 House of Representatives seats in the 2026-02 general election — 3.97 M votes, 6.9%, all via proportional representation** — up from a single House of Councillors seat in 2025, and above its own "five or more" target. Anno has said Team Mirai would *consider joining a ruling coalition if asked* (Japan Times 2026-04-17). Axis B has therefore crossed from "wins *a* seat" to "**wins a legislative bloc**" — the falsifier row is reframed below. ([2026 Japanese general election — results](https://en.wikipedia.org/wiki/Results_of_the_2026_Japanese_general_election), [The Diplomat 2026-03](https://thediplomat.com/2026/03/the-untold-story-of-japans-election-the-quiet-breakthrough-of-team-mirai/))
> - **The QF flagship itself went plural.** Gitcoin **sunset Grants Stack (May 2025)** and launched **"Gitcoin 3.0"** with **GG24** (donation window Oct 14–28 2025) — a *multi-mechanism* funding model over six thematic domains where Quadratic Funding is now one instrument among several (Sybil tooling → **Human Passport**). The largest live QF deployer became *more* plural in the [[concepts/plurality]] sense; "QF adopted in a binding budget" remains the open Axis-B falsifier. ([Gitcoin Grants 24](https://gitcoin.co/campaigns/gitcoin-grants-24-gg24))
> - **New dimension — AI-mediated deliberation ([[concepts/ai-mediated-deliberation]], split out today).** The deliberation half now has an LLM operational layer: **DeepMind's "Habermas Machine"** (*Science* 2024, [DOI 10.1126/science.adq2852](https://doi.org/10.1126/science.adq2852)) drafted group statements that **>5,700 UK participants preferred over human mediators** and that raised within-group consensus; Taiwan's **MODA Alignment Assemblies** run **Polis → Talk to the City** in real policy processes; Team Mirai's "broadlistening" is the same toolkit as a *campaign method*. This welds Axis B to the AI-agent clusters ([[synthesis/open-weight-llm-agent-stack-six-region]] / [[synthesis/agent-runtime-orchestration-six-region]]) and inherits their capture risk — **whoever owns the mediating model can shape the "consensus."** The shared dependency count is now *two*: [[concepts/proof-of-personhood]] (are the participants unique humans?) **and** an open/auditable mediating model. New falsifier row added below.
...
| QV/QF gets adopted in a binding national budget (not just municipal/crypto) | strengthens Axis B beyond niche status — **now within reach:** with Team Mirai holding 11 Diet seats (2026-02) a Plurality party sits *inside* the budgeting body for the first time (still unfired: no binding QV/QF budget yet) |
| A Plurality-inspired party wins elected office | **✅ FIRED DECISIVELY (2025→2026):** Japan's **Team Mirai** ([[entities/audrey-tang|Takahiro Anno]], explicitly [[concepts/plurality]]-inspired, running on AI "broadlistening") went **1 House of Councillors seat 2025 → 11 House of Representatives seats 2026-02 (3.97 M / 6.9%)** — Axis B crossed from experiment to legislature to **parliamentary bloc** weighing a coalition role |
| An LLM out-mediates human facilitators in a controlled deliberation study | **✅ FIRED (2024):** DeepMind's **Habermas Machine** (*Science*, >5,700 UK participants) produced group statements preferred over human-mediator statements and raised consensus — [[concepts/ai-mediated-deliberation]] is now evidence-backed, *and* introduces a **second** capture chokepoint (who owns the mediating model) on top of PoP |
| PoP/EUDI deployments interoperate into one portable human credential | the 100-year "public-infrastructure" branch wins |
| AI-agent Sybil attacks defeat one-human-one-vote at scale before PoP matures | both axes collapse back to platform/state control (and an AI mediator would faithfully synthesize the manufactured consensus) |

## See also

- [[concepts/plurality]] · [[concepts/ai-mediated-deliberation]] · [[concepts/dsnp]] · [[concepts/proof-of-personhood]]
