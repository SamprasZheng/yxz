...
|------|-----------|---------|
| Upstream RF PA | ★★★★★ World leader | [[entities/win-semiconductors]] (3105) — FY2025 rev NT$16.6B, >50% global GaAs foundry share; H1-2026 rev NT$9.85B, EPS NT$3.56 (Q2 +39% YoY, EPS NT$2.30 beat); **Jul+Aug-2026 both 56-month highs (Aug NT$1.937B +30.55% YoY), 8M rev NT$13.68B +33% YoY**; optical-datacom (1.6T PD) + LEO RF the twin Q3 drivers |
| Upstream filters/waveguides | ★★★★★ | [[entities/ascend-tech]] (3491, UMT) — H1-2026 rev NT$1.922B, gross margin ≈56.9% (up from 47.3% in 9M-2025), EPS NT$8.15 (H1 profit alone beat every prior full-year total); **Aug-2026 NT$321M +93% YoY, 8M rev NT$2.474B +73% YoY (already > full-year 2025)**; LEO now **80% of revenue**; in Starlink/Kuiper supply chain |
| Upstream high-frequency PCB | ★★★★★ | [[entities/huatong-pcb]] (2313, Compeq) — analyst ~80% LEO-dedicated-PCB share (directional, unaudited); H1-2026 rev NT$39.54B +13.2% YoY; **Aug-2026 NT$7.01B +6.9% YoY**; 2026 satellite-board est. ~NT$18.5B (+22%) |
...
1. Taiwan's upstream LEO advantages are real and, per **8-month 2026 actuals (through Aug)**, **accelerating *with margin expansion*, not compression** (UMT GM 47.3%→**56.9%**, H1 profit alone beat every prior full year, Aug rev +93% YoY with 8M already exceeding full-year 2025; Win Jul+Aug both 56-month highs, 8M +33% YoY; Compeq Aug +6.9% YoY) — the "operators dual-source → margins compress" risk (falsifier #5) has **still not** triggered two-thirds of the way through 2026; but none of this **automatically extends to hyperscale midstream C**.
