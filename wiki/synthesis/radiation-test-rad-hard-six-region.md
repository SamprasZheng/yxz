...
- **Taiwan — the 2023 half-step.** The [[concepts/taiwan-radiation-test-ecosystem|NSPO consortium]] (2020) + the NTU Cancer Center superconducting-cyclotron MoU (2022, proton SEE from 2023) closed the TID and proton gaps domestically. Heavy-ion SEE and any rad-hard IC remain absent — the same "absent midstream/gate" shape as [[synthesis/phased-array-rf-frontend-supply-chain]] and [[synthesis/leo-taiwan-odc-gap]].
