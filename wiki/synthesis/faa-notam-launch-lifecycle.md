...
**Regulatory (deregulatory turn — now with a dated NPRM).** Part 450 transition is **complete as of 2026-03-10** — all US launch/reentry licensing now runs under one framework (14 Part 450 licenses issued since 2021; legacy holders — Blue Origin, Firefly Alpha, SpaceX Falcon/Dragon, Rocket Lab Electron, ULA Atlas/Vulcan — transitioned by 2026-03-09). The **EO "Enabling Competition in the Commercial Space Industry" (2025-08-13)** directs the FAA to *"reevaluate, amend, or rescind"* Part 450 and to *"eliminate or expedite"* NEPA reviews; **FY2025 closed at a record 204 licensed operations (195 launches + 9 reentries, ≈+25% on FY2024's 148; SpaceX flew 161 of the 195)**, and the FAA Aerospace Forecast projects a flatter **~209–214 for FY2026** as Starlink-V3/Kuiper shift from build-out to replenishment. **The EO→rulemaking step has now shipped (verified 2026-09-22):** the FAA's *"Waiver of Specified Statutory Requirements for Commercial Space Launch and Reentry Actions"* NPRM (**RIN 2120-AM51, Federal Register 2026-07-30**, Parts 400/420/433/437/450) proposes to invoke the DOT Secretary's **statutory-waiver authority (51 U.S.C. § 50905(b)) to waive requirements under 13 laws** — a *waiver-not-rewrite* route that reaches "default-to-yes" faster than a full Part 450 rewrite. *Agent implication:* the **environmental-review** and **completeness-check** clocks (the L-90→L-30 band in §3) are the ones being compressed, and a granted waiver can drop *specific statutory checks* outright; model shorter *review* latency going forward, but **do not** relax the § 450.101 **EC ≤ 10⁻⁴** flight-commit gate — it is statutory and unchanged, so weather/technical/LCOLA slip drivers keep their full weight. Full detail: [[sources/faa-ast-launch-licensing-2025]] §2a, [[sources/faa-part-450-2020]] §1a.

**Empirical slip record (Starship 2025→2026).** IFT-9 (2025-05-27, ~14-day regulatory slip) → IFT-10 (2025-08-26, success) → IFT-11 (2025-10-13, last Block 2, success) → **Flight 12 / V3** (2026-05-22, partial; new Launch Pad 2) → **Flight 13 / V3** (2026-07-24 22:45 UTC, success — first 20 operational Starlink V3 sats deployed; ~8-day slip from a 2026-07-16 T-0 flight-software auto-abort + a Jul 23 weather scrub) → **Flight 14 / V3 (Block 3, Booster 21 + Ship 41)** — the first planned *orbital* Starship test (orbital insertion + **26 operational Starlink V3** + single-Raptor deorbit + Pacific splashdown), **NET slipped Sep 15 → Sep 28, 2026** and still **pending as of 2026-09-22** (a ~13-day program-schedule slip with no mishap open — the readiness-bounded class, not the investigation-bounded tail). The record confirms three priors the `slip_probability()` model in §10 should encode explicitly: (a) **regulatory/first-of-type holds dominate the long tail** (the multi-week+ gaps were mishap-closure and V3 bring-up, not weather), so the flat `Starship: 0.35` historical scrub weight should be **conditioned on vehicle-block maturity** — V3 itself matured fast (Flight 12 partial → Flight 13 all-goals-met); (b) **the AHA polygon grows at each vehicle-version step** (IFT-9 Bahamas/Turks & Caicos → V3's wider footprint), so diffing the E)-field polygon at version boundaries is a machine-readable early-warning signal; and (c) **a T-0 flight-software auto-abort is not a NOTAM state change** — Flight 13's abort→re-flight happened *inside* the NOTAM's pre-cleared backup windows, so the FSM in §4 stayed in `NOTAM_FILED/ACTIVE` throughout and the "launch happened" signal had to come from telemetry/AST, not from a NOTAMR/NOTAMC. Full record: [[concepts/launch-window-slip]] §3a, [[sources/notam-starship-ift8-2025]] §4a.
