...
- **Abundant durable blockspace** — [[concepts/jam]] (transaction-less, open testnet **Jan 2026**, Gray Paper v1.0 targeted before mid-2026, ~43 multi-language clients / 10 M DOT prize — **~15 M1 deliveries lodged by Jan 2026**; **mainnet OpenGov vote expected Q3–Q4 2026**, full delivery framed "12–20 months" by core devs) executing on the [[concepts/polkavm|PolkaVM (PVM)]] RISC-V substrate (**Revive contracts already live on Polkadot Hub 2026-01-20** — the same VM shipping on the contract layer ahead of the JAM relay-chain cutover) and metered by [[concepts/agile-coretime]] (cloud-style reserved + spot coretime, revenue **burned**).
...
|---|---|---|
| **Europe** | core dev + governance (Web3 Foundation Zug / Parity Berlin-London) | JAM Gray Paper origin; MiCA; eIDAS 2.0 EUDI wallets (Dec 2026) ↔ PoP |
| **US** | capital access, dev-thin | DOT spot-ETF filings (21Shares, Grayscale/Nasdaq) pending, decisions extended |
