...
|---|---|---|---|---|
| **US 🇺🇸** | **FAA** Air Traffic Org / AIM (NMS since 2026-04-18) | KZ** ARTCCs (KZJX, KZHU, KZLA…) | **Authoritative, maturing to dynamic** | World's highest cadence; [CSINAS ConOps](https://www.faa.gov/sites/faa.gov/files/space/airspace_integration/Final_CSINAS_ConOps.pdf) + **Time-Based Procedures** + dynamic windows now cut mean closure from **>4 h → just over 2 h per launch** ([FAA Airspace Integration](https://www.faa.gov/space/airspace_integration)); Airspace Management Plans (AMP) bundle TFR/AHA/DRA; **SDI** real-time telemetry; statutory deadline to complete NAS space-integration by **Dec 2026** (FAA Reauthorization Act), full Part 450 applies to all licenses from **2026-03-10** |
| **Europe 🇪🇺** | **EUROCONTROL EAD** (central repository) + national ANSPs (NATS/CAA UK, LFV Sweden, Avinor Norway, Isavia Iceland) | EGPX, ESAA, ENOR, BIRD (oceanic) | **Federated-but-pooled** | EAD = world's largest AIM system; new spaceports **SaxaVord** (Shetland, EGPX; RFA ONE inaugural still pending), **Esrange** (Kiruna, ESAA), **Andøya** (Norway) publish **Temporary Danger Areas** — [Isar Aerospace](https://isaraerospace.com/mission-updates-overview) Spectrum flight 2 reached T-seconds on **2026-03-25 but auto-aborted when an unauthorised vessel entered the designated danger zone** (the pooled-Danger-Area mechanism working as designed; reflight NET 2026-08-31); Isavia ANS coordinates N-Atlantic commercial-space ops |
| **China 🇨🇳** | **CAAC** (state) | ZBPE, ZSHA, ZGZU… | **Sovereign-opaque** | Inland sites (Jiuquan/Xichang/Taiyuan) drop spent stages over *land*; closures often short-notice ("[zero warning](https://www.scientificamerican.com/article/china-launches-rival-to-spacex-falcon-9-with-zero-warning/)"); **[Zhuque-3](https://www.space.com/space-exploration/launches-spacecraft/chinese-company-landspace-targets-aug-10-for-historic-rocket-launch-and-landing-attempt)** (LandSpace) flight 2 orbital + land-recovery attempt **2026-08-10** (Jiuquan → Minqin, Gansu ~300–390 km downrange over Chinese territory — RTLS-over-land, unlike US ocean recovery); **Long March 12** from Wenchang **2026-08-16** set a debris drop zone inside the **Philippine EEZ** (Palawan/Tubbataha, published via NOTAM); the 2024-11 seven-block + 2025-02 ~1,000 km Shanghai→Guangdong closures; debris NOTAMs reach the Philippines (CAAP) and the **Taipei FIR** |
...
| Claim | Status (2026-08) | What would falsify it |
|---|---|---|
| Airspace axis is ICAO-harmonized, not sovereign | Holds (Annex 15 universal; ICAO HAO concept advancing) | A major power formally exiting Annex 15 NOTAM format for space ops |
...
| China closures are short-notice/strategic | **Reinforced** (Aug-2026: "zero warning" launch; LM-12 drop zone in Philippine EEZ; Zhuque-3 land-recovery over Gansu) | CAAC adopting standardized 48–72 h advance launch-NOTAM practice |
