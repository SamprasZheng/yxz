...
|---|---|---|---|---|
| **US 美** | **Open HTTP protocols + crypto rails** | x402 (Coinbase), ACP (OpenAI+Stripe), AP2 (Google), MPP (Stripe+Tempo), Visa TAP, Mastercard Agent Pay — see [[concepts/x402-protocol]] | Protocol leadership; volume still small but **cleaning up and growing**: **~157M cumulative txns / ~$41M settled on-chain across 7 chains & 18 facilitators (2026-07-19)**, ~75M of them in the trailing 30 days (front-loaded), and **95% of txns now ≥ $1 (up from 49% early 2025)** — wash/test traffic receding ([Chainalysis, June 2026](https://www.crowdfundinsider.com/2026/06/283501-chainalysis-shares-insights-on-agentic-payments-reaching-key-milestone-x402-protocol-shows-signs-of-traction-on-base/); [Major Matters tracker, 2026-07](https://majormatters.co/x402)) | **GENIUS Act** enacted 2025-07-18; 1:1 reserves; stablecoins explicitly not securities/commodities ([Latham](https://www.lw.com/en/insights/the-genius-act-of-2025-stablecoin-legislation-adopted-in-the-us)) |
...
| **Korea 韓** | **Tech-giant vs. bank won-stablecoin race** | KakaoBank won-stablecoin wallet (May 2026); Naver Financial + Dunamu "Giwachain"; 8-bank consortium | Pre-launch; KakaoPay is an x402 Foundation founding member (Western-rail hedge) | **Legislative fast-track (July 2026):** ruling party + FSC agreed 2026-07-20 to accelerate the **Framework Act on Digital Assets** (Phase 2 = won-stablecoin legalisation) with fortnightly National Assembly reviews, targeting **Sept 2026**; FSC moved 2026-07-29 to consolidate ~10 bills into a single **Digital Asset Basic Act**; 51%-bank-consortium issuance rule unresolved ([Crypto Times, 2026-07-20](https://www.cryptotimes.io/2026/07/20/south-korea-targets-september-for-won-stablecoin-bill-vows-fortnightly-reviews/); [2026-07-29](https://www.cryptotimes.io/2026/07/29/south-korea-fsc-moves-to-merge-crypto-bills-set-stablecoin-rules/)) |
| **Europe 歐** | **Regulation-first; dollar-stablecoin dependence *realised*** | EURC (Circle, dominant); digital euro; Mastercard/Santander/PayOS live agent payment; [[entities/ripple|Ripple]] full MiCA CASP (2026-07-06) | First live end-to-end EU AI-agent payment = Mastercard + Santander + PayOS (Mar 2026); Adyen is an x402 Foundation member | **MiCA CASP licensing fully in force 2026-07-01** (grandfathering closed; ~244 CASPs authorised, fines ≤12.5% turnover). **"Digital dollarization" is now fact**: **USDT was forced off EU platforms**, leaving **USDC the sole authorised dollar stablecoin** and Circle ~**41% of the euro-stablecoin market** — prompting a **MiCA review**: Commission consultation on extending rules to non-EU stablecoin issuers runs **2026-05-20 → 2026-09-30**, review report due **by 2027-06-30**, legislative rewrite expected **2027, not 2026** ([Genfinity](https://genfinity.io/2026/07/08/mica-enforcement-ripple-casp-license-europe-stablecoin/); [Coindesk, 2026-06-30](https://www.coindesk.com/policy/2026/06/30/europe-is-rewriting-its-landmark-crypto-rulebook-mica-as-hard-july-1-deadline-passes)) |
...
| Claim on the cluster | What would falsify it | Status (2026-07) |
|---|---|---|
| "Agentic payments are taking off" | x402 real (non-wash) daily volume flat at ~$28K through 2026 | **Mixed → improving (July 2026)** — absolute settled volume still small (~$41M cumulative), but the count is compounding (~157M cumulative, ~75M in the trailing 30 days) and **95% of txns now ≥ $1, up from 49% early 2025**, i.e. test traffic is being displaced by real usage ([Chainalysis, June 2026](https://www.crowdfundinsider.com/2026/06/283501-chainalysis-shares-insights-on-agentic-payments-reaching-key-milestone-x402-protocol-shows-signs-of-traction-on-base/); [Major Matters tracker](https://majormatters.co/x402)) |
