...
## Sources (verified 2026-06-08; fact-refreshed 2026-07-17, 2026-07-29, 2026-08-17)
...
- **[2026-08-17 refresh — hanging watch resolved + declining-phase anchor]** The 2026-07-29→31 watch was **extended into 1 August** and then **under-performed its "up to G3" ceiling by ~2 levels, resolving to only G1–G2** (with an S1 radiation storm on 30 July) — the exact mirror of the 3–4 July case that *over*-performed (G2 forecast → G3 observed). Together with the 2026-02-01 **X8.1** flare (SC25's 3rd-strongest; R3 blackout but only a glancing-CME **G1** storm), the three 2026 events make the two-sided point that CME **severity forecasts err in both directions** because internal Bz and impact geometry are unknown until L1 — [SWPC watch extension](https://www.spaceweather.gov/news/geomagnetic-storm-watches-now-continue-1-august), [SWPC X8.1 report](https://www.spaceweather.gov/news/update-x81-strong-flare-region-4366). Declining-phase anchor: through 2026-05-31 SC25 has produced **104 X-class flares**, with **2 of the cycle's 10 strongest recorded in the descent (Oct 2025 – Feb 2026)**, and SIDC now projects SC25 to **run until ≈2030** — [SIDC "Progress of SC25"](https://www.sidc.be/article/progress-sc25-0). Full storm/flare chain in [[concepts/solar-cycle-25-leo-radiation]]. *(Primary SWPC/SIDC feeds were egress-blocked for direct fetch this run; figures verified via authoritative-source search summaries.)*
