...
> **Live in 2026 — the "third" round is open (DA 26-552, rel. 2026-06-05).** The round mechanism is **actively operative under the existing Part 25 rules** (the Part 100 opt-in bonded round in §3 below is a *future* replacement still gated on OMB). In early 2026 the FCC granted the two dominant operators large capacity increases via **waivers conditioned on future-round participation** — **SpaceX Gen2 "V3 Upgrade," DA 26-36 (2026-01-09): +7,500 Gen2 → ~15,000 authorized**; **Amazon Leo (formerly Project Kuiper) (2026-02-10): +4,504 (3,212 Gen2 + 1,292 polar) → 7,727 authorized**. Then, via **DA 26-552 (2026-06-05)**, the Space Bureau **opened a third Ku-/Ka-band round (10.7–30.0 GHz) and a third V-band round (37.5–51.4 GHz)** with a **2026-07-06 filing cut-off**, folding SpaceX's and Amazon Leo's operations into the respective rounds. For interference-attribution this is the pattern to internalize: *grant capacity provisionally, then adjudicate co-frequency contention in a round.* Full mechanics + sources in [[concepts/processing-round]].

> **Regularization done (adopted 2026-07-22, released 2026-07-23):** the Part 100 R&O (**FCC 26-47**, SB Docket 25-306, rel. 2026-07-23) was **adopted unanimously** at the 2026-07-22 Open Meeting. It replaces the *highly discretionary* Part 25 processing-round rules with a **rules-based, calendared, opt-in process**: applicants opt in to a round with a fixed annual **filing window (Jan 1 – Oct 31)** and post a **$10 M surety bond within 30 days of authorization** that declines to **$0 at 90 % deployment**. The round is deliberately carved out of the new "default-to-yes" assembly line as one of seven **targeted review categories** that still get full scrutiny. For the Mission Desk's early-warning monitoring (§4), the *timing* of contested-band rounds is now forecastable to a fixed calendar window. See [[concepts/processing-round]].
>
> **Status re-verified 2026-08-28:** ~5 weeks post-release the Part 100 R&O had **not yet appeared in the Federal Register** — only the underlying **NPRM** is published there (FR Doc **2025-22019**, *Space Modernization for the 21st Century*, published **2025-12-05**), so the "effective date pending" reading below still holds; the usual cause of the lag is **Paperwork Reduction Act / OMB review** of the new certification-based information collections. The accompanying **FNPRM** (the only portion open for public comment) is the forward pipeline — it seeks comment on further reforms including **Space-Based Experimental Licensing** and **NGSO call-sign merging** (consolidating a constellation's many per-satellite call signs into one network record). *(Sources: [FCC — "FCC Adopts Groundbreaking Overhaul," DOC-423287A1](https://docs.fcc.gov/public/attachments/DOC-423287A1.pdf); [Federal Register — Space Modernization NPRM (2025-22019)](https://www.federalregister.gov/documents/2025/12/05/2025-22019/space-modernization-for-the-21st-century), accessed 2026-08-28.)*
...
| **SpaceX Starlink** | **Gen2 "V3 Upgrade" partial grant (DA 26-36)** — +7,500 Gen2 (→ ~15,000 authorized); milestones 50 %/2028-12-01, 100 %/2031-12-01; **processing-round waiver conditioned on future-round participation** | +7,500 | Ku/Ka/V | **2026-01-09** |
| **Amazon Leo** (ex-Kuiper) | **Conditional grant** — +4,504 (3,212 Gen2 + 1,292 polar), → **7,727** authorized; 50 %-by-2026-07-30 milestone; round waiver conditioned on future-round participation | +4,504 | Ku/Ka/V | **2026-02-10** |
| **FCC (processing rounds)** | **DA 26-552 / DA 26-553** — Space Bureau **opens third Ku/Ka (10.7–30.0 GHz) + third V-band (37.5–51.4 GHz) rounds**; competing apps due 2026-07-06 (under legacy Part 25) | round opened | Ku/Ka + V | **rel. 2026-06-05** |
...
| **FCC (Part 100)** | Space Modernization **R&O + FNPRM** (**FCC 26-47**, SB Docket 25-306) — Part 25 → **Part 100** "licensing assembly line," default-to-yes (7 targeted-review carve-outs incl. Processing Round), **20-yr terms** (from 15), opt-in processing round (Jan 1–Oct 31 window + $10M declining surety bond), 15-day public-notice window (from 30), C-band/radio-altimeter relocation, certifications-over-showings | licensing-process overhaul | all satellite/earth-station | **ADOPTED unanimously 2026-07-22, rel. 2026-07-23** (not yet in Fed. Reg. as of 2026-08-28; effective date pending PRA/OMB review) |

**For interference attribution**: Starlink Gen2 (now **~15,000** Ku/Ka/V-band authorized after the 2026-01-09 V3 Upgrade grant) and **Amazon Leo** (ex-Kuiper; **7,727** authorized after the 2026-02-10 grant, incl. a 1,292-sat polar shell) are the dominant co-frequency sources in Ku/Ka bands, both now folded into the 2026 third rounds. AST introduces a new cellular-band (700 MHz / 850 MHz) interference class not previously associated with LEO FSS. [[entities/starcloud]] and [[entities/ada-space]] orbital data center operators in LEO are the most exposed to these interference environments. **New in 2026:** for the Ku/Ka bands above, the attribution test shifts from "did the operator exceed a fixed EPFD limit" to "did it degrade GSO service quality under the performance-based framework, and had good-faith coordination been reached" — a qualitatively different evidentiary question for the Mission Desk verb.
...
- **Track open processing rounds as a leading indicator.** When the Space Bureau opens a round (most recently **DA 26-552, 2026-06-05** — third Ku/Ka + third V-band, cut-off **2026-07-06**), the filing window flags *exactly which bands are about to see a wave of new/expanded NGSO applications*. A round open in your operating band is the strongest early warning that the co-frequency environment is about to change; the cut-off date bounds when the new entrants become knowable. Under the forthcoming Part 100 opt-in round (§2.2), that window becomes a fixed annual **Jan 1–Oct 31** calendar — even more forecastable.
...
- Part 25 standard license term: 15 years; small satellite: 6 years; processing time: 6–9 months (uncontested GSO) to 24+ months (NGSO processing round). *(The adopted Part 100 R&O (2026-07-22) extends most space/earth-station terms to **20 years** and cuts the public-notice window to **15 days** from 30 — see below.)*
...
- **Part 100 (Space Modernization), FCC 26-47, SB Docket No. 25-306 — ADOPTED unanimously 2026-07-22, RELEASED 2026-07-23** (underlying NPRM published in the Federal Register as FR Doc 2025-22019 on 2025-12-05; NPRM comments 2026-01-20, replies 2026-02-18). **Status as of 2026-09-24:** the R&O had *still not* appeared in the Federal Register as a 2026 final rule (only the 2025 NPRM, FR Doc 2025-22019, is published). The **effective-date mechanism is now precise and two-track**: most of the Order takes effect **60 days after Federal Register publication**, *except* **§§ 9.10, 9.18, and 100.1–100.34** — the core new Part 100 licensing sections (which include the opt-in bonded processing round) — which become effective **only after OMB completes its PRA review of the new information collections**, announced separately by the Space Bureau via a later FR notice. So the round-relevant Part 100 sections are gated on **OMB**, not merely on the 60-day clock; this is why the 2026 third round (above) ran under legacy **Part 25**, not Part 100. The accompanying **FNPRM** (the only portion open for public comment) seeks comment on further reforms, including **Space-Based Experimental Licensing** and **NGSO call-sign merging**. The Report and Order + FNPRM relocates Part 25 into the new **Part 100** "licensing assembly line" with a **"default-to-yes" presumption** — a compliant application is presumed in the public interest *unless* it falls into one of **seven targeted-review categories** (Failure to Certify, Waiver Requests, Market Access, Foreign Ownership, **Processing Round**, Spectral Constraints, Federal Coordination). It **extends most space/earth-station license terms to 20 years** (from 15; shorter on request, early retirement allowed), **cuts the public-notice window to 15 days** (from 30) for typical requests, and **keeps the processing round but makes it opt-in and bonded** — a fixed **Jan 1–Oct 31 filing window** + a **$10 M surety bond** posted within 30 days of authorization that **declines to $0 at 90 % deployment** (plus milestone conditions). It also adopts adjacent-band **radio-altimeter coexistence** measures, a **Lower C-band incumbent-relocation** transition with FAA-retrofit rebates, and resolves 2020 C-band reconsideration petitions; enforcement includes automatic termination on milestone/operate failure, revocation, and forfeitures. This is a **process** overhaul distinct from the **FCC 26-26** EPFD interference-rule change above.
- **Processing-round lineage:** five modern Ku/Ka/V NGSO FSS waves — 2016 (OneWeb-triggered, closed 2016-11-15; first modern round), 2017, 2020 (Kuiper-triggered), 2021 (~81,195 sats requested), **2026** (third Ku/Ka + third V-band rounds opened by DA 26-552, 2026-06-05, cut-off 2026-07-06); ~43 NGSO FSS applications through 2021 (the 2026 round reopens the count); the round is a US-specific instrument with no clean six-region equivalent
- **2026 constellation grants (both waiver-conditioned on future-round participation):** SpaceX Gen2 "V3 Upgrade" **DA 26-36** (2026-01-09, +7,500 Gen2 → ~15,000 authorized; 50 %/2028-12-01, 100 %/2031-12-01); **Amazon Leo** (Project Kuiper rebranded) 2026-02-10 conditional grant (+4,504 = 3,212 Gen2 + 1,292 polar → 7,727 authorized; 50 %-by-2026-07-30 milestone)
