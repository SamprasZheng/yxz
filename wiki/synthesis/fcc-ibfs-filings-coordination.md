...
> **Regularization done (adopted 2026-07-22):** the Part 100 R&O (**FCC 26-47**) was **adopted unanimously** at the 2026-07-22 Open Meeting. It replaces the *highly discretionary* Part 25 processing-round rules with a **rules-based, calendared, opt-in process**: applicants opt in to a round with a fixed annual **filing window (Jan 1 – Oct 31)** and post a **$10 M surety bond within 30 days of authorization** that declines to **$0 at 90 % deployment**. The round is deliberately carved out of the new "default-to-yes" assembly line as one of seven **targeted review categories** that still get full scrutiny. For the Mission Desk's early-warning monitoring (§4), the *timing* of contested-band rounds is now forecastable to a fixed calendar window. See [[concepts/processing-round]].
