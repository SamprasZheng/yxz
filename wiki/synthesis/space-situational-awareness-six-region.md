...
sources:
  ...
  - "[[sources/esa-space-environment-report-2026]]"
concepts:
...
> **繁體中文摘要**
> 本頁補上現有「近接/太空態勢感知（SSA）」頁面缺少的一塊：六地域（台美日韓中國歐洲）的**國家級太空監視基礎設施**比較。核心論點：全球唯一**具法律權威**的接近資料（CDM）來源仍是美國太空軍（18/19 SDS，經 Space-Track.org；民用本欲轉移至商務部 TraCSS，但此交棒 2025–26 遭預算政治化——FY2026 提案一度砍除、國會恢復至 $52.5M、FY2027 又要求砍約八成，時程延後、改研議使用者付費，OSC 並依 2025-08-13 行政命令上移至商務部長直轄）；歐洲走**聯邦協調**路線（EU SST 夥伴關係 15→19 國，整合 GESTRA／GRAVES／TIRA 等國家雷達）；中國走**主權＋多邊**路線（CNSA 碎片中心＋APSCO 的 APOSOS 光學網，資料不公開）；日本軍民並進、2023–2026 快速擴建（Kamisaibara 雷達＋Bisei 光學＋2025/03 新雷達＋FY2026 SDA 衛星）；韓國以天文機構（KASI／OWL-Net 五站光學網）為主、雷達仍待建；台灣civil（TASA）尚無專屬 SSA 雷達，僅有鋪龍 PAVE PAWS 預警雷達兼測、實質為美國 SDA 與商業資料的**消費者**，利基在算力與狀態向量。長期（~100 年）結構觀：即使今天停止所有發射，碎片仍將增長 200 年以上（ESA SER 2026：已追蹤 >43,000 顆 >10 cm、LEO 碰撞風險自 2024 年上升約 20%、部分 LEO 或已進入自我維持的早期 Kessler 區間），Kessler 級聯使「目錄權威歸誰」成為主權問題；可追蹤靈敏度下限（~5–10 cm）以下的「致命但不可追蹤」1–10 cm 族群，是 SSA 永恆的前沿。
...
| **美 US** | USSF Space Delta 2 — [[entities/18-sds]] (catalog) + 19 SDS (conjunction assessment); DoC **OSC** [[sources/tracss-oasis-announcement-2024]] (civil; elevated to report directly to the Secretary of Commerce per the **2025-08-13 EO** "Enabling Competition in the Commercial Space Industry") | **SSN** ~30 sensors; **Space Fence** (Kwajalein, op. 2020, ~5 cm LEO); GEODSS optical; Cobra Dane | **Authoritative** global catalog (**>43,000 tracked**, ESA SER 2026 [[sources/esa-space-environment-report-2026]]); **sole legally-authoritative CDM source** | Military-origin; civilianizing via TraCSS **but that hand-off is now budget-contested** (★★★★★) |
...
1. **US — authoritative-but-militarily-originated, and now internally contested.** The 18/19 SDS catalog is the only CDM source with *legal* standing for US-licensed satellites, and de-facto the global default ([[entities/space-track-19sds]]). The strategic move of the decade *was* **civilianization**: handing routine conjunction screening to the DoC [[entities/space-track-19sds|Office of Space Commerce]] via [[sources/tracss-oasis-announcement-2024|TraCSS]] so the military keeps the SDA mission while a civil agency owns space-traffic management. **That hand-off is no longer a settled 2026 milestone.** NOAA's FY2026 budget proposal (mid-2025) sought to *terminate* federal TraCSS funding on the theory that the commercial sector should absorb it; the Space Force publicly opposed the cut; Congress restored the money at **$52.5M enacted for FY2026** — but the **FY2027 request again seeks ~$11M (≈80% cut)** to OSC, the "fully operational by January 2026" target slipped, OSC is studying a **user-fee** model, and a **2025-08-13 EO** elevated OSC to report directly to the Secretary of Commerce (out from under NOAA; Taylor Jordan named director 2025-12-02). **Update (fact-check 2026-08-25): the ~$11M PBR has again failed in the appropriations process for a *second consecutive year* — the House Appropriations Committee's FY2027 CJS bill (approved 2026-05-13) provides ~$50M for OSC with report language supporting continued TraCSS work, and Senate appropriators likewise moved to *retain* TraCSS funding (exact Senate FY2027 mark not yet public). So the budget-political threat is real but has now been rejected by both chambers' appropriators in two straight cycles — the "structurally sticky" reading is strengthening against the "terminate" reading, though neither the FY2027 enacted level nor the user-fee question is settled.** As of mid-2026 TraCSS is an expanded, *internationalising* beta — **52 pilot users + the first two national-government accounts (UK, Australia), ~11,125 satellites** — not yet the authoritative production replacement. So the US model is a single point of authority that is *also* a single point of budget-political failure. Canonical fact-check + provider-selection implication: [[concepts/conjunction-screening-providers]] §"The 2025–2026 budget near-death and rescue."
...
**Anchored facts ([[sources/esa-space-environment-report-2026|ESA *Space Environment Report 2026*]], 10th ed., 2026-05-01):** **>43,000 objects tracked >10 cm** by surveillance networks; MASTER-8 models **~1.2 million objects 1–10 cm** and **>140 million <1 cm**; **~9,300 active payloads** + **>2,000 spent rocket stages**; **>15,000 tonnes** total mass, concentrated in LEO; **LEO collision risk up ~20% since 2024**, with the report noting that parts of LEO **may already be entering a self-sustaining (early-Kessler) growth regime**. The structural finding is unchanged and hardening: **even with zero further launches the orbital population keeps growing for 200+ years** — fragments are created faster than drag removes them — so active debris removal (ADR), not mitigation alone, is the only path to a stable environment. (Prior editions of this page cited SER 2025's >40,000 / ~54,000-modeled figures; the wiki has since ingested [[sources/esa-space-environment-report-2026|SER 2026]] and this page now anchors on it.)
...
|---|---|---|
| Space-Track / 18 SDS is the only *legally authoritative* CDM source | A non-US catalog (EU SST, China, a UN registry) gains regulatory standing for non-US operators' maneuver obligations | Holds; TraCSS is still US-DoC, not international (though it now carries UK + Australia national accounts as *users*, not authorities) |
| US civil STM is durably transitioning to TraCSS | TraCSS loses federal funding and civil screening reverts to DoD / commercial-only | **Weakened but re-stabilising (2026-08-25)**: FY2026 termination proposed → restored at $52.5M; FY2027 PBR again cuts OSC ~80% (~$11M) → **House Appropriations Committee FY2027 CJS bill (2026-05-13) restores ~$50M + TraCSS report language, Senate appropriators also retain funding** — a second-consecutive-year congressional rejection of the cut. The transition is budget-contingent, not scheduled, but appropriators have now twice overridden the termination attempt; user-fee model still under study |
...
| Even zero launches → 200+ yr debris growth | A revised ESA/IADC model showing near-term net decay without ADR | Holds, strengthened ([[sources/esa-space-environment-report-2026|ESA SER 2026]]: LEO collision risk +20% since 2024; parts of LEO entering a self-sustaining regime) |
...
- ESA, *ESA Space Environment Report 2026* (10th ed., 2026-05-01) — [[sources/esa-space-environment-report-2026]] ; https://www.sdo.esoc.esa.int/environment_report/Space_Environment_Report_latest.pdf (prior *SER 2025* — https://www.esa.int/Space_Safety/Space_Debris/ESA_Space_Environment_Report_2025)
- TraCSS FY2026 budget contest — Breaking Defense, "Appropriators restore funding for Commerce's TraCSS spacewatch effort" (2025-07) — https://breakingdefense.com/2025/07/appropriators-restore-funding-for-commerces-tracss-spacewatch-effort/ ; SpacePolicyOnline, "Senate Appropriators Retain Funding for NOAA's TraCSS"; Payload, "NOAA Proposes Terminating TraCSS Program" — https://payloadspace.com/noaa-proposes-terminating-tracss-program/ ; Air & Space Forces Magazine, "Space Force… Commerce Cuts Space Traffic Management Program" — https://www.airandspaceforces.com/space-force-opposes-to-cutting-tracss-program-from-commerce-budget/
- **TraCSS FY2027 budget contest (fact-check 2026-08-25)** — FY2027 PBR ~$11M (April 2026); House Appropriations Committee FY2027 CJS bill (approved 2026-05-13) ~$50M for OSC + report language supporting TraCSS; Senate appropriators move to retain TraCSS funding — SpaceNews, "Commerce Department budget proposal revives concerns about TraCSS" ; SpacePolicyOnline, "Senate Appropriators Retain Funding for NOAA's TraCSS" ; CRS R48929, "Overview of FY2027 Appropriations for Commerce, Justice, Science, and Related Agencies (CJS)"
- OSC elevation — Executive Order "Enabling Competition in the Commercial Space Industry" (2025-08-13); U.S. Dept. of Commerce, "Commerce Secretary Appoints New Leadership for Office of Space Commerce" (Taylor Jordan, 2025-12-02) — https://www.commerce.gov/news/press-releases/2025/12/commerce-secretary-appoints-new-leadership-office-space-commerce
