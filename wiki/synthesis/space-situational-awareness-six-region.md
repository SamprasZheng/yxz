...
| US civil STM is durably transitioning to TraCSS | TraCSS loses federal funding and civil screening reverts to DoD / commercial-only | **Weakened**: FY2026 termination proposed → restored at $52.5M, but the FY2027 request cuts OSC ~80% and a user-fee model is under study — the transition is now budget-contingent, not scheduled |
