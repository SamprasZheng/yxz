...
- `[[synthesis/spacesharks-mission-desk-verification-plan]]` — Verification & test plan for the NVIDIA Agent Challenge 2026 entry; seven-layer test pyramid across four deployment surfaces (Open Cloud / Nemo Cloud / NemoClaw Sandbox / Docker); Nemotron-attestation enforced at L1/L3/L7 as the non-negotiable submission gate. Canonical for "is the entry deployable on every declared surface and does it prove it runs Nemotron."
