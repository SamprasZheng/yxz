...
- `[[synthesis/spacesharks-mission-desk-verification-plan]]` — Verification & test plan for the NVIDIA Agent Challenge 2026 Mission Desk entry; four deployment surfaces (Open Cloud / Nemo Cloud / NemoClaw Sandbox / Docker) + seven-layer test pyramid; Nemotron-attestation as the non-negotiable submission gate. Canonical for "how do we prove the hackathon entry works on every surface."
