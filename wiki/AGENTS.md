...
- `[[synthesis/spacesharks-mission-desk-verification-plan]]` — Verification & test plan for the Mission Desk NVIDIA Agent Challenge 2026 entry; four deployment surfaces (Open Cloud / Nemo Cloud / Sandbox / Docker); seven-layer test pyramid; Nemotron-attestation enforced at L1/L3/L7 as the non-negotiable submission gate. Canonical for "how do we prove the Mission Desk works on every surface and ship it."
