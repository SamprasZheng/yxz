...
[Article 50](https://artificialintelligenceact.eu/article/50/) of the EU AI Act requires that providers of AI systems generating synthetic content mark outputs in a machine-readable format detectable as AI-generated. The markings must be effective, interoperable, robust, and resistant to deliberate removal. **Now in force — applied on schedule 2 August 2026.** The key 2026 development the May-2026 "provisional agreement" only anticipated: the **Digital Omnibus** (Reg. (EU) 2026/1744, entered into force ~27 July 2026) that *postponed the high-risk regime* deliberately **left Article 50 untouched** — transparency applied 2 Aug 2026, and the Article 50(2) machine-readable-marking obligation keeps its four-month grace to **2 December 2026** for GenAI systems already on the market before 2 Aug 2026 ([Usercentrics](https://usercentrics.com/knowledge-hub/eu-ai-act-high-risk-delay-article-50-transparency-consent/); [Mayer Brown, "Digital Omnibus on AI"](https://www.mayerbrown.com/en/insights/publications/2026/07/eu-ai-act-news-digital-omnibus-on-ai-new-guidance-on-risk-classification-gpai-and-transparency-obligations)). By contrast the **high-risk deadlines slipped** — Annex III high-risk to **2 December 2027**, Annex I to **2 August 2028** — so the transparency/provenance layer is the one that arrived on time while the accuracy/robustness conformity layer got a reprieve (relevant to [[concepts/calibrated-confidence-llm]]'s "calibration-as-assurance = market-access gate" read). A Commission [Code of Practice on AI-generated content](https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content) operationalises Article 50(2), converging on C2PA as the reference marking format. For the Mission Desk, every published row carries `recommended_by` (which agent version) and `evidence_hash` (tamper-evident source link) — satisfying the machine-readable marking and preservation-of-provenance obligations that are now *live law*, not pending, in the EU market.
...
| **Europe** | **EU AI Act Article 50(2)** — now **in force**, applied **2026-08-02** (marking grace to 2026-12-02); the July-2026 **Digital Omnibus** postponed high-risk but *not* Article 50; Code of Practice + C2PA reference | **Yes (live)** | Machine-readable marking, "effective/interoperable/robust/removal-resistant" | Regulation-led, standard-converging |
...
- **2025–2026:** provenance goes *mandatory* and the dates arrive — China GB 45438 (Sep 2025, now a year in force), Korea AI Basic Act (Jan 2026), and **EU Article 50 applied on schedule 2 Aug 2026** (the July-2026 Digital Omnibus postponed the high-risk regime to Dec-2027/Aug-2028 but spared the transparency layer — so provenance is now *live law*, ahead of the accuracy/robustness conformity layer); **C2PA v2.4 (Apr 2026)** extends manifests to unstructured text/LLM output — the exact artefact an agent emits.
