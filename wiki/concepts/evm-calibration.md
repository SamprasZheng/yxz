...
| 1024-QAM | **≈1.8%** (extrapolated, not a spec cell — see note) | calibration/converter/phase-noise-limited regime |

> **Fact-check resolved 2026-09-14** (supersedes the 2026-08-24 "not primary-verified" flag): two claims that had been merged must be split. **(1) 1024-QAM *support* is ratified** — an *optional downlink* modulation added in **3GPP Release 17**, so far fielded only in FR1 fixed-wireless-access / controlled links, not mobile. **(2) The ≈1.8% EVM is an industry *extrapolation*, not a distinct ratified cell** — TS 38.104 Table 6.5.2.2-1 stops at 256-QAM = 3.5%; the ≈1.8% figure is the QPSK→256-QAM halving pattern continued by Keysight/R&S/RF-Essentials, widely reported but not a 3GPP-defined ceiling. (Prior wording "ratified ... ≈1.8%" overstated the second half.) Dated primary marker that the order has crossed from spec-option to certifiable: **Keysight won the first GCF-recognized validation of 5G NR FR1 1024-QAM demodulation test cases on 2024-07-29** — the T&M tier now *measures* 1024-QAM even where the transmit-EVM cell remains extrapolated. Meeting the ~1.8% target demands the full acceptance stack past 256-QAM: integrated phase noise <~0.3° RMS, PA linearization ([[concepts/dpd-digital-predistortion|DPD]]) with strong IMD suppression, and IQ calibration at the sub-0.1 dB / sub-0.5° level — the binding constraint sits on the converter/LO/calibration layer, not the PA.
