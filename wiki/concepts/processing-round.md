...
**ADOPTED 2026-07-22 (was: scheduled).** The FCC voted **unanimously** at the 2026-07-22 Open Meeting to adopt the **Report and Order + Further Notice of Proposed Rulemaking** ("Space Modernization for the 21st Century," **FCC 26-47**), relocating and reorganizing the Part 25 rules into the new **Part 100** ("Space and Earth Station Services"). What the adopted Order actually did, with the processing round now confirmed:
