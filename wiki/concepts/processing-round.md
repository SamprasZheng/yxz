...
**Status as of 2026-07-21:** a **Report and Order + Further Notice of Proposed Rulemaking** ("Space Modernization for the 21st Century") is **circulated for the full-Commission vote at the 2026-07-22 Open Meeting** (10:30 AM ET) — i.e. *scheduled, not yet adopted* on the date of this note. Per the FCC's **July-1-2026 fact sheet** and the tentative agenda (released 2026-07-15), the R&O — if adopted as circulated — would:
- **Replace Part 25 with a new Part 100** ("Space and Earth Station Services"), with a **presumption that any application meeting the rules is in the public interest** (the "default-to-yes" assembly line);
- **Regularize the NGSO/NGSO processing round.** The R&O adopts a **robust NGSO–NGSO sharing framework** and replaces the *highly discretionary* Part 25 processing-round rules with a **rules-based, transparent, predictable process** — one under which "applicants can plan for a processing round to open" rather than depending on staff discretion;
- **Extend most space- and earth-station license terms to 20 years** (from the Part 25 standard 15);
- **Remove surety-bond requirements** for most non-processing-round licenses;
- Create a new **Variable Trajectory Space Station** license category; and
- Accept **certifications in place of detailed technical showings** for many requirements.
The accompanying **FNPRM** seeks comment on further changes building on the new Part 100. *(Sources: [FCC — July 2026 Open Meeting](https://www.fcc.gov/July2026); [FCC Tentative Agenda for July 2026, DOC-422735A1](https://docs.fcc.gov/public/attachments/DOC-422735A1.pdf); [FCC Fact Sheet — Space Modernization for the 21st Century, 2026-07-01, DOC-422740A1](https://docs.fcc.gov/public/attachments/DOC-422740A1.pdf); [FCC Space Modernization NPRM](https://www.fcc.gov/document/space-modernization-21st-century-nprm), accessed 2026-07-21.)*

**This answers the open question the pre-vote framing posed.** The round is *not* abolished and *not* purely "assembly-lined away": co-frequency NGSO contention still needs a concurrent-review rule, and the R&O makes that rule **more predictable and less discretionary** rather than removing it — the "simplified and time-boxed rather than abolished" fork below is the one the circulated text takes. See [[concepts/schedule-s]] for the Part 25 → Part 100 form-model transition (20-year terms, single-Form-312, certifications) and [[concepts/epfd-equivalent-power-flux-density]] for the *separate* 2026-04-30 move (FCC 26-26) from fixed EPFD limits to performance-based GSO protection with good-faith coordination. The two tracks are distinct — Part 100 modernizes the **licensing process**, FCC 26-26 changed the **NGSO/GSO interference rule** — but together they push both NGSO/NGSO and NGSO/GSO contention from FCC *allocation* toward operator *bargaining* under a regulatory backstop.

## Long-Horizon View (labelled scenario)

Near term (2026–2030): the direction is now visible in the circulated Part 100 R&O (above) — the round is **regularized and made rules-based** (not abolished) and increasingly paired with a robust NGSO–NGSO sharing framework + good-faith coordination rather than case-by-case staff-adjudicated splits. Structural fork (not a forecast): either (i) domestic batching **withers** as performance-based, coordination-first rules let operators privately partition shared spectrum — the round becomes a rarely-invoked backstop; or (ii) as LEO Ku/Ka fills and V/Q/E and optical inter-satellite bands contend, batching **intensifies** and other large markets (EU, eventually) grow their own round-like processes. Either way the binding long-run scarcity is not the US round but the ITU FCFS orbital-slot enclosure it sits beneath ([[synthesis/space-regulatory-regimes-six-region]]).
