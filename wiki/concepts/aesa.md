...
|---|---|---|---|
| **US** | Leads — APG-77/81, SPY-6, 80+ space AI/SDA programs; DoD raised GaN to MRL-10, >$3B radar funding 2024–25 | Leads beamformer ICs (Analog Devices, **Qorvo** — absorbed **Anokiwave** Q1 2024) and RF GaN (**Qorvo, MACOM** — MACOM bought Wolfspeed's RF GaN-on-SiC line 2023, RTP fab transferred Jul 2025; Wolfspeed now SiC-substrate-only, post-Ch.11); merchant L1+L2 **consolidating** (see [[synthesis/phased-array-rf-frontend-supply-chain]]) | Designs + much of GaN-on-SiC capacity |
...
- **Silicon-beamformer power trend (2025-03 → volume 2026):** Qorvo's Ku-band SATCOM silicon beamformer ICs (AWMF-0240 Rx / AWMF-0241 Tx, cutting terminal power up to 25% Tx / 14% Rx) reached **volume production Q1 2026**, joined by the **AWMF-0247** (Quad 4×1 TDD for LEO *user terminals*) and Ka-band AWMF-0238/0239 — the SiGe/CMOS-displaces-discrete trend behind the LEO flat-panel volume above, now shipped by a **vertically-integrated** Qorvo (post-Anokiwave) — [Qorvo TDD beamformer IC](https://www.qorvo.com/newsroom/news/2025/qorvo-introduces-tdd-beamformer-ic).
