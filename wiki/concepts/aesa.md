...
**Beam squint & true-time-delay.** A *phase* shifter produces the correct steering angle only at the design frequency; across an instantaneous bandwidth $\Delta f$ the beam "squints" by $\Delta\theta \approx -\tan\theta_0 \cdot (\Delta f/f_0)$. For wideband apertures (wideband SATCOM, radar) the fix is **[[concepts/true-time-delay-beam-squint|true-time-delay (TTD)]]** at the sub-array level rather than pure phase shift — the same wideband pressure that pushes hybrid arrays toward per-sub-array TTD and all-digital beamforming (the squint law $\Delta\theta \approx -\tan\theta_0\,\Delta f/f_0$ and its TTD fix now have a canonical page). Element-level amplitude/phase errors (from PA nonlinearity, temperature, aging) raise sidelobes and degrade EVM, which is why per-element [[concepts/dpd-digital-predistortion|DPD]] and [[sources/hsieh-xband-leo-transmitter-2020|BIST self-calibration]] become mandatory as $N$ grows.
...
|---|---|---|---|
| **US** | Leads — APG-77/81, SPY-6, 80+ space AI/SDA programs; DoD raised GaN to MRL-10, >$3B radar funding 2024–25 | Leads beamformer ICs (Analog Devices, **Qorvo** — absorbed Anokiwave 2024; Qorvo AWMF-0247 shared-aperture flat-panel added 2026) and GaN PA (**Qorvo, [[entities/macom]]** — absorbed Wolfspeed's RF GaN 2023; runs both GaN-on-SiC + GaN-on-Si) | Designs + much of GaN-on-SiC capacity; GaN-on-Si for cost-volume mmWave |
...
## Sources & Verification (accessed 2026-05-31; market re-checked 2026-07-10; six-region refresh 2026-07-24; KF-21 airframe/deployment refresh 2026-08-10; US GaN-vendor consolidation 2026-08-30; GaN substrate split + 2026 product anchors 2026-09-19)
...
- SATCOM beamformer-IC market: **estimates diverge** by source — Semiconductor Insight (re-verified 2026-07-24) puts it USD **2.87B (2025) → 3.21B (2026) → 7.94B (2034), 10.6% CAGR**; SNS/Verified/DataIntelo reports span ~USD 4.3–6.9B (2025–26) with 11–19% CAGRs. Treat the *direction* (double-digit growth driven by LEO flat-panel volume) as robust and the *level* as uncertain — [Phased Array Beamforming IC for SATCOM (Semiconductor Insight)](https://semiconductorinsight.com/report/phased-array-antenna-beamforming-ic-for-satcom-market/); vendor products — [Anokiwave SATCOM](https://www.anokiwave.com/satcom/index.html), [Renesas phased-array beamformers](https://www.renesas.com/us/en/products/rf-products/phased-array-beamformers)
- **Silicon-beamformer power trend (2025-03):** Qorvo launched Ku-band SATCOM silicon beamformer ICs (AWMF-0240 Rx / AWMF-0241 Tx) cutting terminal power by up to 25% (Tx) / 14% (Rx) — the SiGe/CMOS-displaces-discrete trend behind the LEO flat-panel volume above.
- **US GaN-on-SiC supply bottleneck (2026):** US RF-foundry utilization ~80–90% with beamforming-IC / GaN-PA lead times **20–35 weeks** — a binding capacity constraint on terminal output; APAC upstream (Japan/Korea/Taiwan) holds ~55–65% of regional GaAs/GaN RFIC value-add (2026 forecast) — [Phased Array Beamforming ICs Market (SNS Insider)](https://www.snsinsider.com/reports/phased-array-beamforming-ics-market-9280)
- Korea KF-21 AESA series-production milestone (2025-08; ~1,000 GaN T/R modules; Hanwha hardware / LIG Nex1 software; 40 sets 2025–2028; service late 2026): [The Defense Post](https://thedefensepost.com/2025/08/08/korea-kf21-aesa-radar/); [Flight Global](https://www.flightglobal.com/fixed-wing/hanwha-systems-rolls-out-first-production-kf-21-aesa-radar/164082.article)
...
- **GaN substrate split + 2026 products (2026-09-19):** MACOM runs both GaN-on-SiC (CMPA2H3B025D 25 W Ka-band 27–31 GHz) and GaN-on-Si; L/S-band T/R (1 W, >40 dB gain, >40% eff, PURE CARBIDE®), shown SATShow Week + IMS 2026 — [MACOM IMS 2026 SATCOM](https://www.macom.com/updates/news/2026/macom-ims-2026-product-announcements-for-satellite-communication); GaN-on-Si ~2× cheaper on 8-inch Si but ~1/3 SiC thermal conductivity — [PatSnap Eureka](https://www.patsnap.com/resources/blog/rd-blog/gan-on-sic-vs-gan-on-si-rf-power-amplifiers-patsnap-eureka/); Qorvo AWMF-0247 shared-aperture flat-panel beamformer + 0240/0241 volume prod. Q1 2026 — [everythingRF](https://www.everythingrf.com/news/details/19793-qorvo-introduces-new-silicon-ku-band-satcom-beamformer-ics-for-phased-array-terminals)
...
- [[concepts/true-time-delay-beam-squint]] — the wideband beam-squint constraint and its TTD fix (frequency dimension of the array-factor math above)
