...
- **TVL re-check (verified 2026-08-20) — flat-thin, crown held.** DefiLlama shows the **Hydration chain ≈ $55.1M TVL** (top Polkadot chain) with the **Hydration DEX-specific portion ≈ $24.83M** — essentially unchanged from the ~$55M mid-2026 read, i.e. the ~6× peak-to-trough compression *held* rather than deepened or recovered over the quarter. **DOT ~$0.72–0.76** (intraday low **$0.7238 on 2026-08-18**, off an early-August peak near **$0.87**), still sub-$1 — so the "largest on Polkadot, but market-beta-thin" reading is stable, not deteriorating. ([DefiLlama — Polkadot chains](https://defillama.com/chains/polkadot), [DefiLlama — Hydration DEX](https://defillama.com/protocol/hydration-dex), [CoinGabbar — DOT Aug-2026](https://www.coingabbar.com/en/price-prediction/polkadot-price-prediction-august-2026-target-levels))
- **TVL/price re-rate (verified 2026-09-09) — DOT reclaims $1; TVL re-rates upward (figure unverified).** DOT broke above the descending trendline that capped it since May: a short-liquidation squeeze (Sept 5→7) drove a local high **~$1.03 on 2026-09-07**, extending to **~$1.20 by 2026-09-09** (**+~42% week**, **+~65% off the 2026-08-18 low of $0.7238**) — the **first time above $1 in all of 2026**. Because Hydration's TVL is heavily DOT/vDOT-collateralised, this ~+65% move mechanically re-rates the dollar TVL upward from the ~$55M Aug read; **the exact Sept figure could not be verified this pass — DefiLlama was egress-blocked**, so the delta is stated directionally, not quantified. The *relative* "Polkadot's largest DeFi protocol" crown is unchanged (Hydration leads parachain TVL by >5× the next-largest, Bifrost). This retires the cluster-wide "DOT sub-$1 / market-beta-thin" framing that ran since 2026-07-06 — the beta is now a *tailwind*, off a deeply compressed base. ([CoinGabbar — DOT +42% week](https://www.coingabbar.com/en/price-prediction/polkadot-price-prediction-up-42-percent-week-reach-2), [cryptonews.net — DOT reclaims $1](https://cryptonews.net/news/analytics/33407824/))
- **HOLLAR — first institutional-use signal (verified 2026-08-01):** the **Polkadot Technical Fellowship switched its own payments from USDT to HOLLAR, effective June 2026** — i.e. a core Polkadot institution now *denominates real spending* in the native CDP stablecoin rather than a bridged dollar token. This is a materially stronger adoption signal than the borrow-cap raises: it is protocol-native demand for HOLLAR as a **settlement/payment** asset, not just a leverage instrument, and it directly advances the "reduce reliance on bridged USDC/USDT" thesis (the bridged-dollar path being exactly the [[concepts/xcm|Hyperbridge-style bridge risk]] the ecosystem is trying to route around). HOLLAR launched **2025-09-22**. ([blockchain.news — Fellowship switches payments to HOLLAR](https://blockchain.news/flashnews/polkadot-fellowship-switches-payments-hollar), [Phemex — HOLLAR launch](https://phemex.com/news/article/hydration-launches-decentralized-stablecoin-hollar-on-polkadot-20226))
