...
| 2026-08-02 → 08-18 | **G1** (minor; isolated) | Late-July CME tails + minor Earth-directed CMEs | Declining-phase quiet-to-minor baseline: G1 on 2–3 Aug (M1.9 CME tail), Kp 4 warning 14 Aug, a CME arriving late 17 Aug → G1 (chance G2 if Bz turns south) with unsettled 18 Aug; **no G4+** all month — the "rare-but-severe punctuating quiet" declining-phase signature | [SWPC alerts archive](https://www.spaceweatherlive.com/en/reports/noaa-swpc-alerts-watches-and-warnings.html) |
