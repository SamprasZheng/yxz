...
## Adoption Status (updated 2026-09 — cross-chain tracker snapshot)

| Metric | Value | Notes |
|---|---|---|
| Cumulative transaction count (cross-chain) | **182M** (2026-09-03); ~169M mid-Aug; 160M+ (Coinbase, Aug); ~157.4M tracked (2026-07-19) | count keeps compounding across **7 chains / 18 tracked facilitators** ([Chainalysis via blockchain.news, 2026-09-03](https://blockchain.news/flashnews/x402-settlements-flat-41-6m-since-april); [Major Matters x402 tracker](https://majormatters.co/x402)) |
| **Settled value — the key 2026-09 print** | **~$41.6M cumulative, FLAT since April; ≈$0.23/txn; daily volume −93% YTD** | the count-vs-value split has hardened into a *plateau* — 182M payments but the same ~$41M settled as in April; rails scale, real settled demand does not ([Chainalysis via blockchain.news, 2026-09-03](https://blockchain.news/flashnews/x402-settlements-flat-41-6m-since-april)) |
...
| **Busiest week of 2026 (week of 2026-08-17)** | **~8.7M transfers / only ~$367,950 value** | busiest onchain agent-to-agent week of the year, **>2× the prior week's 4.1M**; but peak-week *value* is trivial vs the 2025 peak week's **$10.017M** — count compounding, value shrinking per-txn ([Cryptonomist/Chainalysis, 2026-08-25](https://en.cryptonomist.ch/2026/08/25/agentic-stablecoin-payments-record/)) |
| **USDC share of agentic settlement volume** | **≈ 99%** (98.6% precise; "nearly 100%"; re-verified 2026-09) | **USDT essentially absent** despite being #1 stablecoin by market cap; nearly every agent-payment surface defaults to USDC for its Circle-attestation + US-banking compliance profile — the rail is *governance*-plural (Ripple/Stellar joined) but *settlement*-monocultural. *The prior "99.99%" was read only through egress-blocked domains; now corroborated by two named outlets and refined slightly downward* ([Cryptonomist, 2026-08-25](https://en.cryptonomist.ch/2026/08/25/usdc-ai-payments-dominance/); [Cryptobriefing](https://cryptobriefing.com/usdc-dominates-agentic-transfer-volume-x402/)) |
...
| Share of txns valued ≥ $1 | **95%** (up from 49% in early 2025) | Chainalysis — *the* signal that wash/test activity is receding; mirror-image, the **10¢–$1 band collapsed from 46% → 4%** over the same window, i.e. the sub-dollar test/wash tier is being squeezed out, not the genuine micro-tier merely diluted |
...
**Note (wash-trading, updated 2026-08)**: A CoinDesk (2026-03) investigation found ~half of observed x402 transactions were "gamified" (wash/testing) rather than genuine commercial demand. Chainalysis traced the specific mechanism: the Q4-2025 volume surge was driven largely by **PING**, a "pay-to-mint" meme experiment that required users to query a URL, receive an HTTP 402, and pay 1 USDC to mint tokens — turning x402 into a speculative game (PING alone processed 150,000+ txns in its first month; weekly volume spiked >10,000%). The **Chainalysis figure that 95% of transactions are now ≥ $1 (up from 49% in early 2025), with the 10¢–$1 band collapsing 46% → 4%,** is the first quantitative sign that real, sub-dollar-filtered usage is displacing that test/wash traffic — though absolute volume remains small versus China's [[entities/ant-group-alipay|Alipay AI Pay]] (~300M cumulative txns). Consistent with the 25-year micropayment-failure lineage analysed in [[synthesis/agentic-payments-six-region]].
