...
**Long-horizon note:** the providers above all chase the same moving target. Per the [[sources/esa-space-environment-report-2026|ESA *Space Environment Report 2026*]] (10th ed.), even if all launches stopped today the orbital population would keep growing for **200+ years** (Kessler cascade) — **LEO collision risk is up ~20% since 2024** and parts of LEO may already be entering a self-sustaining regime — and the **1–10 cm "deadly-but-untrackable" gap** (~1.2 M modeled objects) below the ~5–10 cm sensor floor is the permanent SSA frontier — see [[synthesis/space-situational-awareness-six-region]] §4.
...
- OSC's **Consolidated Pathfinder** (2024, extended into 2026; ~$15.5M total) tasks the commercial providers by role: **[[entities/leolabs|LeoLabs]]** LEO radar tracking, **[[entities/slingshot-aerospace|Slingshot]]** LEO optical search/track, **COMSPOC** enterprise catalog maintenance, with **SpaceNav** + **[[entities/kayhan-space|Kayhan Space]]** as independent data-quality-monitoring vendors ([AMOS 2024 Consolidated-Pathfinder paper](https://amostech.com/TechnicalPapers/2024/Poster/Magnus.pdf); [OSC pathfinder-partners announcement](https://space.commerce.gov/office-of-space-commerce-announces-commercial-partners-for-new-tracss-pathfinder-project/))
- Separately, the **Commercial Collision Avoidance Gap Pathfinder** (2025) pays SDA firms to track satellites in the high-risk window *immediately after launch*, before the object is catalogued; LeoLabs's cross-government/interagency award to feed TraCSS (and track adversarial spacecraft) runs through ~mid-March 2026 with extension options ([Payload](https://payloadspace.com/leolabs-lands-cross-government-licensing-contract/), [SpaceNews](https://spacenews.com/leolabs-lands-interagency-contract-to-feed-tracss-and-track-adversarial-spacecraft/); LeoLabs entity detail: [[entities/leolabs]])
- TraCSS will aggregate commercial provider data and provide a single civil interface at TraCSS.gov — but as of Sept 2026 the *commercial-data integration* into the operational pilot remains unresolved (see budget section below)

### The 2025–2026 budget near-death and rescue (fact-check, accessed 2026-07-11; refreshed 2026-08-05, FY2027 detail 2026-08-15; FY2027 congressional-restoration update 2026-08-25; footprint + program-scale refresh 2026-09-25)
...
- **Structural elevation, but a renewed FY2027 cut:** a **2025-08-13 EO** ("Enabling Competition in the Commercial Space Industry") directed OSC to be **elevated to report directly to the Secretary of Commerce** — out from under NOAA, at parity with it in the Department (Taylor Jordan named OSC director 2025-12-02). Yet the **FY2027 budget request again seeks only ~$11M for OSC** — an **≈83% cut from the $65M the office received in FY2024**, and ≈79% below the $52.5M FY2026 enacted level (the Senate FY2026 mark had been $60M). So higher bureaucratic stature has not resolved the funding fragility; if anything the elevate-then-defund pattern reinforces the "commercial sector should absorb it" thesis, and industry read the ~$11M request as another OMB attempt to curtail TraCSS. ([SpaceDaily — 83% cut](https://spacedaily.com/sd-n-an-83-budget-cut-to-the-office-of-space-commerce-puts-americas-space-traffic-management-future-in-limbo/), [Breaking Defense](https://breakingdefense.com/2025/07/appropriators-restore-funding-for-commerces-tracss-spacewatch-effort/), [Commerce](https://www.commerce.gov/news/press-releases/2025/12/commerce-secretary-appoints-new-leadership-office-space-commerce), [The Conversation](https://theconversation.com/office-of-space-commerce-faces-an-uncertain-future-amid-budget-cuts-and-new-oversight-265710))
- **FY2027 congressional restoration — the cut is again failing (fact-check 2026-08-25):** as in FY2026, the ~$11M PBR is not surviving the appropriations process. The **House Appropriations Committee's FY2027 CJS bill (approved 2026-05-13) provides ~$50M for OSC** with report language supporting continued TraCSS work, and **Senate appropriators likewise moved to *retain* TraCSS funding** (the exact Senate FY2027 mark not yet public). Neither chamber's number is enacted, but both rejected the termination attempt — a **second consecutive year** the OMB/PBR cut has been overridden, which is the strongest available evidence for the "structurally sticky anchor" reading over the "commercial sector absorbs it" reading. ([SpaceNews — "Commerce Department budget proposal revives concerns about TraCSS"](https://spacenews.com/commerce-department-budget-proposal-revives-concerns-about-tracss/), [SpacePolicyOnline — "Senate Appropriators Retain Funding for NOAA's TraCSS"](https://spacepolicyonline.com/news/senate-appropriators-retain-funding-for-noaas-tracss-space-traffic-system/), [CRS R48929 — FY2027 CJS overview](https://www.congress.gov/crs-product/R48929))
- **Work continues under FY2026 money (accessed 2026-08-15):** OSC Director Taylor Jordan states TraCSS work is proceeding on the FY2026 appropriation — **onboarding satellite operators and containerizing the codebase** — while OSC simultaneously studies the program's future operating/financial structure ([FedScoop](https://fedscoop.com/space-commerce-official-tracss-continues-despite-budget-uncertainty/)). The **operator waitlist opened February 2026** ([[sources/tracss-oasis-announcement-2024]]).
- **Footprint trajectory (April → Aug 2026):** the beta expanded fast and *internationalised* — 35 pilot users / 10,696 satellites (April) → 52 pilots + the first 2 National Government Accounts (UK, Australia) / ~11,125 satellites (June) → **70 pilot users + 10 National Government Accounts / >11,345 satellites (August 2026)**, all registering directly through the TraCSS webpage. The 10 NGAs are **Australia, Brazil, Egypt, Finland, Germany, Norway, the Republic of Korea, Singapore, Switzerland, and the United Kingdom** ([OSC — "TraCSS Update: Expanding Space Safety Partnerships"](https://space.commerce.gov/tracss-update-expanding-space-safety-partnerships/), accessed 2026-09-25). This is a real milestone — a five-fold NGA jump in ~2 months — but still short of an authoritative production replacement for [[entities/space-track-19sds|Space-Track]].
- **Production ≠ production-as-authority (added 2026-09-25):** OSC released the **TraCSS *production environment* in March 2026 with 17 users**, formally starting the pilot period; but as of the [Via Satellite fact-check (2026-08-26)](https://www.satellitetoday.com/government-military/2026/08/26/tracss-traffic-coordination-system-remains-in-pilot-mode-due-to-budget-uncertainty/) the system **remains in pilot mode "due to budget uncertainty,"** with commercial-SSA-data integration still unresolved and no declared authoritative-production date. "Production environment live" is an infrastructure milestone, **not** the legal-authority handoff — an important distinction the earlier "production 2026" framing blurred.
- **Program-scale anchor (added 2026-09-25, 拉高維度):** TraCSS is now characterised as a **nearly decade-long, ~$200M program** (SPD-3 issued 2018 → beta late-2024 → production-env March-2026 → still pilot Sept-2026). That the *institutional* build has taken ~8 years and ~$200M to reach an internationalising-but-non-authoritative beta is itself the strongest evidence for this cluster's recurring thesis: the hard part of civil STM was never the [[concepts/cdm-conjunction-data-message|CDM format]] or the Pc math — it is **catalog authority + sustained appropriations**, and both remain contingent.
- **Six-region read of the NGA list (added 2026-09-25, 水平展開):** the 10 NGAs map unevenly onto the wiki's six regions — **Europe** heavily represented (Germany, Finland, Norway, Switzerland), **Korea** in (the only one of the four Asian wiki regions), and **Japan, China, Taiwan absent**. Japan runs its own JAXA/MoD SDA build-out + hosts the US [[entities/18-sds|SĀCHI/QZS-7]] payload (partner, not TraCSS consumer); China is sovereign-closed by design; Taiwan is a consumer of US SDA but not (yet) a national-account holder. So TraCSS's internationalisation is tracking the *allied-federated* half of the [[synthesis/space-situational-awareness-six-region|six-region SSA map]], not the sovereign-closed half — consistent with its governance model.
...
- [[sources/esa-space-environment-report-2026]] — the debris environment all providers track against (SER 2026)
