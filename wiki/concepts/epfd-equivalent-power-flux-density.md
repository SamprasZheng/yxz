...
- **WRC-23 (2023):** leaves the Article 22 *values* unchanged but **refers a study of aggregate NGSO EPFD behaviour to the WRC-27 cycle** (agenda set in **Resolution 813 (WRC-23)**). The review targets the **Region 1 & 3 NGSO-FSS** EPFD limits; industry expectation is *possible action* at **WRC-27 (Shanghai, 2027)** with any **relaxation** potentially deferred to **WRC-31**. **CPM27-2** (which drafts the technical options) is planned for **April 2027**. That the largest FCFS filer (China — see [[concepts/itu-biu-milestone-regime]]) hosts the conference reviewing the megaconstellation-constraining EPFD rule is a notable alignment.
