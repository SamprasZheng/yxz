...
**Verified example:** Starship IFT-5 (October 2024) generated NOTAM `F3682/24` specifically for the Ship (Stage 2) atmospheric re-entry and splashdown zone, in addition to the main AHA NOTAM for the ascent phase. By 2026 Starship had moved to **Version 3 (V3)**: Flight 12 (first V3, 2026-05-22) was declared a mishap and grounded pending an FAA-required investigation (closed 2026-07-13); **Flight 13** flew successfully 2026-07-24 from Pad B — after a T-0 ignition abort (2026-07-16, four engines failed to light) and a weather scrub (2026-07-23) — and was the first Starship to deploy operational payload (20 Starlink, suborbital). Each V3 flight still spawns the multi-AHA set (launch-site + ascent-corridor + booster-recovery + Ship re-entry), and the southernmost trajectories close airspace in the Mexico/Cuba/Jamaica/Cayman FIRs. **Flight 14** (NET **2026-09-15**, Starbase Pad B) is the next in sequence — planned as the first *orbital* Starship flight test; watch for its filed AHA NOTAM as the attempt-confirmation signal (see [[concepts/launch-window-slip]]).
...
**Policy context (2026-08) — priority launch corridors:** [NSPM-17](https://www.whitehouse.gov/presidential-actions/2026/08/national-security-presidential-memorandum-nspm-17/) (2026-08-20) directs the FAA to designate **priority airspace for critical space launch corridors**; the FAA opened **RFI Docket FAA-2026-9736** (Fed. Reg. **2026-08-25**, comments due **2026-10-26**). If corridors carry a *standing* designation, some launches may eventually route through pre-allocated airspace rather than a fresh per-event AHA NOTAM — an agent's "NOTAM filed?" signal would then need a corridor-status branch. Analysis in [[synthesis/space-launch-airspace-integration-six-region]]; AHA-parsing impact in [[concepts/launch-hazard-area]] §5.
...
| **Europe** | EUROCONTROL **EAD** + national ANSPs (NATS/CAA, LFV, Avinor, Isavia) | EGPX/ESAA/ENOR/BIRD | **Temporary Danger Areas** for SaxaVord/Esrange/Andøya; pooled in EAD; Isar Spectrum flight 2 **auto-aborted 2026-03-25** when a vessel entered the Andøya danger zone, then **reached orbit 2026-09-05** (first orbital launch from Western European soil) — the pooled Danger-Area model validated end-to-end |
| **China** | **CAAC** (state) | ZBPE/ZSHA/ZGZU | **Short-notice**; inland sites drop spent stages over land (Zhuque-3 land-recovery over Gansu 2026-08-10); a **near-weekly Wenchang → Philippine-EEZ drop-zone cadence** (LM-12 2026-08-16 near Palawan/Tubbataha; LM-5 2026-08-24) published as PhilSA "aerospace flight activity" NOTAMs reaching CAAP (Philippines) + RCAA (Taipei); closures double as strategic signaling |
