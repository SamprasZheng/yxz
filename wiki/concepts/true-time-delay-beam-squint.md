...
- **2025–2026 (now):** two frontiers open at once — **integrated silicon-photonic TTD** (optical delay via slow-light gratings / tunable MZIs, an X-band RF beam steered by a C-band optical carrier wavelength) and **frequency-comb-steered *quasi*-TTD** beamformers that drop physical delay lines entirely for LFM waveforms. Photonics is attractive because optical delay is naturally broadband and low-loss over the delays a large aperture needs. **2026 anchors:** a 4-channel silicon-photonic optical-TTD-line beamformer (8-bit switchable + continuously tunable, **0–394.24 ps** total delay, **120 ns** beam-switching, **±20.19°** steering) was fabricated on the US **AIM Photonics** foundry — i.e. the integrated-photonic-TTD result now rides a *domestic-foundry* PDK, not a one-off; and an **integrated-photonics-assisted THz beamformer for fast squint-free steering** (Wiley *Laser & Photonics Reviews*, 2026) pushes the squint-free-across-band property up into the THz/6G-FR3 regime where fractional bandwidths are largest and squint is worst.
...
- **US** leads the merchant TTD-capable beamformer IC and RF-sampling (Analog Devices, Anokiwave/Qorvo, AMD/Xilinx digital TTD) and much of the integrated-photonic-TTD research base — now with a **domestic silicon-photonics foundry path (AIM Photonics)** carrying the 2026 photonic-TTD results, tightening the same L1/L2 concentration seen in [[synthesis/phased-array-rf-frontend-supply-chain]] onto the photonic-delay layer too.
...
## Sources (accessed 2026-08-10; 2026 photonic-TTD anchors added 2026-09-19)
...
- **2026 silicon-photonic OTTDL beamformer** (4-ch, 8-bit switchable + continuous, 0–394.24 ps total delay, 120 ns switching, ±20.19° steering; fabbed on US AIM Photonics foundry): [Optical Delay Line Technologies for Phased Array Systems — Nature Index topic](https://www.nature.com/nature-index/topics/l4/optical-delay-line-technologies-for-phased-array-systems)
- **2026 integrated-photonics-assisted THz squint-free beamformer:** [Ni et al., *Laser & Photonics Reviews* (2026), doi:10.1002/lpor.202502319](https://onlinelibrary.wiley.com/doi/10.1002/lpor.202502319)
