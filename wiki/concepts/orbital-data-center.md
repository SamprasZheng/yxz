...
| 2026-07-07 | **US** — **Orbital Compute Inc.** (a five-month-old startup, CEO Euwyn Poon; $5M pre-seed from a16z Speedrun) files with the **FCC for up to 100,000 satellites** totalling **10 GW** of compute (100 kW-class nodes, 500–850 km) — a fourth US ODC filer alongside SpaceX/Starcloud, evidence the ODC land-rush is now a multi-entrant FCC queue |
| 2026-07-29 | **China** — [[entities/ada-space]]'s Three-Body pair reports an **8-day continuous laser inter-satellite link**: **192 h 8 m 45 s at 99.99 % data availability over separations up to 1,000 km** — the domain's first *multi-day flown* optical-ISL endurance datum (US comparator: Suncatcher's **1.6 Tbps bench** link + Axiom/Kepler's **2.5 Gbps flown**); begins retiring the optical-ISL chokepoint, scale-player-first |
| 2026-08-21 | **US** — [[entities/starcloud]] raises a **$250M Series A extension** at **$2.3B** (Manhattan West led; NVIDIA + Cisco Investments new; **$450M total raised**) explicitly to **buy scarce launch capacity**; **Starcloud-2 slips from a single Oct-2026 launch to two 8 kW rideshare satellites in 2027** as Falcon 9 rideshare slots book out past late 2028 — the first clear signal that **launch cadence, not payload readiness, is the near-term binding constraint** on the US commercial ODC bet |
| 2026-Q4 (planned) | [[entities/ada-space]] slated to launch its **2nd + 3rd satellite groups** (3rd ≈14 sats, ~3,000 kg to 525 km SSO); [[entities/starcloud]]'s ~88,000-satellite FCC filing remains the paper runway toward gigawatt scale |
| 2027 (targeted) | [[entities/starcloud]] **Starcloud-2** two-satellite rideshare (NVIDIA Blackwell B200 + AWS server blade, live commercial workloads; **largest radiator yet flown**); [[entities/google-suncatcher]] two Trillium-TPU prototypes (early 2027); [[entities/axiom-space]] fully optically-interconnected ODC node aboard the ISS |
