...
> **Update (2026):** The modernization push escalated sharply. In October 2025 FCC Chair Brendan Carr launched "Space Month," and the follow-on NPRM (**SB Docket No. 25-306**) proposed to **replace the entire Part 25 rule set with a new "Part 100 — Space and Earth Station Services,"** introduce a **"default-to-yes" licensing assembly line** (straightforward requests presumed in the public interest and expedited), and a **modular single-Form-312** model in which an entity files its main form once and associates all future license requests with it. Comments were due **2026-01-20**, reply comments **2026-02-18**.
>
> **ADOPTED 2026-07-22, RELEASED 2026-07-23 (was: scheduled).** The **Report and Order + Further Notice of Proposed Rulemaking** (**FCC 26-47**, rel. 2026-07-23) was **adopted unanimously** at the 2026-07-22 Open Meeting, establishing the Part 100 "licensing assembly line" — a compliant application is presumed in the public interest (**"default-to-yes"**) *unless* it falls into one of **seven targeted-review categories** (Failure to Certify, Waiver Requests, Market Access, Foreign Ownership, Processing Round, Spectral Constraints, Federal Coordination). Of direct relevance to this form, the adopted Order: **extends most space- and earth-station license terms to 20 years** (from the Part 25 standard 15; shorter on request), permits **certifications in place of detailed technical showings** for many requirements, keeps the **modular single-Form-312** model, **cuts the public-notice window to 15 days** (from 30) for typical requests, and **regularizes the NGSO/NGSO [[concepts/processing-round|processing round]]** into an opt-in, calendared (Jan 1–Oct 31), bonded ($10M declining to $0 at 90 % deployment) process. The Schedule S → O/F split is subsumed into this larger Part 25 → Part 100 transition; the structured single-form + certification model now replaces the Form-312-plus-Schedule-S showing pattern described below (effective date pending Federal Register publication / PRA review). **Re-verified 2026-08-28:** ~5 weeks post-release the R&O had **not yet appeared in the Federal Register** (only the underlying NPRM, FR Doc **2025-22019**, published **2025-12-05**), so Schedule S remains the operative technical annex until Part 100 takes effect; the lag is consistent with **PRA/OMB** clearance of the new certification-based collections. The Part 100 **FNPRM** additionally seeks comment on **Space-Based Experimental Licensing** and **NGSO call-sign merging**. **Re-verified 2026-09-24:** still no 2026 final-rule FR document; the R&O's **split effective date** is now confirmed — most sections effective **60 days after FR publication**, but **§§ 9.10, 9.18, and 100.1–100.34** (the core Part 100 licensing rules that carry the certification-over-showings + single-Form-312 model replacing Schedule S) take effect **only after OMB completes PRA review**, on a later separate FR notice. So **Schedule S remains the operative form even after the general 60-day trigger** until the OMB-gated Part 100 sections are announced. *(Sources: [DLA Piper — FCC overhauls space and satellite licensing](https://www.dlapiper.com/en-th/insights/publications/2026/07/fcc-overhauls-space-and-satellite-licensing-process-key-changes); [Holland & Knight, 2026-07](https://www.hklaw.com/en/insights/publications/2026/07/ground-control-to-major-reform-fcc-adopts-landmark-overhaul-of-space); docs.fcc.gov + federalregister.gov egress-blocked, mechanism quoted from law-firm summaries of FCC 26-47, accessed 2026-09-24.)* *(Sources: [FCC 26-47 R&O + FNPRM](https://docs.fcc.gov/public/attachments/FCC-26-47A1.pdf); [FCC — “FCC Adopts Groundbreaking Overhaul,” DOC-423287A1](https://docs.fcc.gov/public/attachments/DOC-423287A1.pdf); [Federal Register — Space Modernization NPRM (2025-22019)](https://www.federalregister.gov/documents/2025/12/05/2025-22019/space-modernization-for-the-21st-century); [Covington Global Policy Watch, 2026-07](https://www.globalpolicywatch.com/2026/07/fcc-approves-massive-modernization-of-satellite-licensing-regime/); [FCC — July 2026 Open Meeting](https://www.fcc.gov/July2026), accessed 2026-08-28.)*
