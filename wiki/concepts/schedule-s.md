...
>
> **Status as of 2026-07-21:** a **Report and Order + Further Notice of Proposed Rulemaking** is **circulated for the full-Commission vote at the 2026-07-22 Open Meeting** — *scheduled, not yet adopted*. Per the FCC's **July-1-2026 fact sheet** and the released tentative agenda, the R&O — if adopted as circulated — would establish the Part 100 "licensing assembly line" (compliant applications presumed in the public interest) and, of direct relevance to this form: **extend most space- and earth-station license terms to 20 years** (from the Part 25 standard 15), permit **certifications in place of detailed technical showings** for many requirements, keep the **modular single-Form-312** model, and **regularize the NGSO/NGSO [[concepts/processing-round|processing round]]** into a rules-based process. The Schedule S → O/F split is subsumed into this larger Part 25 → Part 100 transition; if adopted, the structured single-form + certification model replaces the Form-312-plus-Schedule-S showing pattern described below. *(Sources: [FCC — July 2026 Open Meeting](https://www.fcc.gov/July2026); [FCC Fact Sheet — Space Modernization for the 21st Century, 2026-07-01, DOC-422740A1](https://docs.fcc.gov/public/attachments/DOC-422740A1.pdf); [FCC Tentative Agenda for July 2026, DOC-422735A1](https://docs.fcc.gov/public/attachments/DOC-422735A1.pdf); [FCC Space Modernization NPRM](https://www.fcc.gov/document/space-modernization-21st-century-nprm), accessed 2026-07-21.)*
