...
**Lineage of Proof-of-Ink (layer-down / 拉長時間軸, verified 2026-07-31).** PoI is not a 2026 invention — it descends directly from **Kappa Sigma Mu (KΣM), "The Kusama Society," a 2020 on-chain fratority** whose founding consensus concept was literally called **"Proof-of-Ink":** membership required a *permanent tattoo* of the Kusama canary logo / typography / genesis hash (≥2.54 cm, on the body), the un-repeatable physical mark serving as a costly, non-transferable uniqueness signal; the society's pot was funded by a **0.2 % burn of the Kusama Treasury**. Project Individuality's DIM1 **Proof-of-Ink** productises that six-year-old Kusama experiment into a protocol-grade, ZK-anonymised personhood credential — a concrete instance of the corpus-wide pattern where Kusama's "expect chaos" experiments become Polkadot's audited primitives years later. ([Decrypt — the crypto fraternity paying $3,000 for a tattoo](https://decrypt.co/20457/this-crypto-fraternity-will-pay-you-3000-to-get-a-tattoo), [Polkadot Forum — Kappa Sigma Mu](https://forum.polkadot.network/t/kusama-issue-1-treasury-burn-kappa-sigma-mu-and-the-richest-collective-youve-never-heard-of/3059))
...
Gavin Wood filed his **first personal treasury proposal** to fund PoP's initial deployment — **Referendum 1783 (November 2025), the "Polkadot People Initiative" / "Incentives for Mass Polkadot Activation Campaign," requesting $3,009,600** (USDT/USDC on Asset Hub, dollar-cost-averaged into **[[concepts/hydration-omnipool|HOLLAR]]**, Polkadot's over-collateralised stablecoin, on the **People Chain**), which he framed as funding *"the fairest airdrop ever"* and restarting Polkadot's "human-centric growth" trajectory. The disbursement is fully on-chain and intermediary-free (no Parity sign-off), split across **three autonomous incentive mechanisms** — bootstrap rewards for early joiners, governance-participation rewards, and weekly prize draws. **Status (verified 2026-08-12): passing.** The proposal was paused for review, re-activated in late 2025, and by December 2025 had **entered the confirmation period at ~87.7% Aye with ≈160.88 M DOT voting in favour** — resolving the earlier "passage not independently confirmed" flag. The mechanism is intended to complement [[concepts/dot-hard-cap]] (supply scarcity, the *supply* side) with genuine demand from verified human users (the *demand* side) — and to make one-human-one-vote [[entities/polkadot]] OpenGov resistant to AI/bot capture as agentic accounts proliferate. It is also the first concrete, sizeable **HOLLAR demand instance** driven by governance rather than DeFi yield — a data point for the [[concepts/dot-hard-cap|"is the demand sink filling"]] question.
...
- **DIM1 launch DIMs named — Proof-of-Ink (PoI) + Proof-of-Video-Interaction (PoVI)** (PoI descends from the 2020 Kusama Kappa Sigma Mu "Proof-of-Ink" tattoo society, see lineage note above); as of mid-2026 reporting both were *"in the final stages of testing and optimisation… to launch in quick succession in the coming months"* → the Q1 2026 target has **slipped** (a further slip on top of the earlier "Q4 2025 → Q1 2026" one). ⚠️ **Re-checked 2026-08-12: still no confirmed mainnet-live date for PoI/PoVI** — public reporting continues to describe the Q1→Q2→Q3-2026 (DIM1→DIM2→mainnet) *plan* rather than a shipped launch; the slip persists into H2 2026. Note the asymmetry with the *funding* side, which **has** cleared governance (Ref. 1783 below): the money is approved but the mechanism it funds has not yet shipped. Flagged for re-check next pass.
- **Referendum 1783** (Nov 2025), the **"Polkadot People Initiative" / "Incentives for Mass Polkadot Activation Campaign"**: **$3,009,600** treasury request (USDT/USDC → DCA'd into **HOLLAR** on the **People Chain**) to fund initial deployment ("the fairest airdrop ever") — Gavin Wood's first personal treasury proposal; goal = onboard millions of verified-unique users irrespective of token holdings; three autonomous on-chain incentive tracks (bootstrap / governance-participation / weekly draws). **Passage now confirmed (2026-08-12):** paused-for-review, re-activated, then **entered confirmation at ~87.7% Aye / ≈160.88 M DOT in favour** (Dec 2025).
...
- **[2026-08-12 fact-check]** Ref. 1783 entered confirmation ~87.7% Aye / ≈160.88 M DOT; $3,009,600 → HOLLAR on People Chain; three autonomous incentive tracks; paused-then-reactivated — [Polkadot People Initiative (Subsquare #1783)](https://polkadot.subsquare.io/referenda/1783), PolkaWorld (X) confirmation-entry + reactivation posts; DIM1 PoI/PoVI still no shipped-launch date as of Aug 2026 (public reporting still plan-stage)
