...
The product name for Polkadot's PoP system is **Project Individuality**. It is built from multiple **Decentralised Individuality Mechanisms (DIMs)** — Gavin Wood describes these as *"personhood games"* engineered to make it costly or difficult for one person to register as many identities (Sybil resistance), without a central KYC authority.

| Stage | Name | Description |
|---|---|---|
| DIM1 | Proof of Individuality | Basic uniqueness: prove you are not the same person as any other registered participant. Code reported *"basically complete"* on the technical-fellowship calls (June 2025). |
| DIM2 | Proof of Verified Individuality | Layer real-world identity signals on top of DIM1 uniqueness |
| DIM3+ | Further mechanisms | Additional personhood games / privilege tiers; rolling out through 2026 |
...
- Announced July 2025 (Berlin Web3 Summit) as part of the "Second Era" package
- **Project Individuality** targeted launch Q4 2025; further DIMs rolling out through 2026
- **Referendum 1783** (Nov 2025): ~$3 M treasury request to fund initial deployment ("fairest airdrop ever")
