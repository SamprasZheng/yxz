...
- The size of the AHA can **shrink over successive flights** as the operator accumulates reliability data — this is a vehicle-level learning effect across flights, not a within-flight dynamic. For Falcon 9, the AHA has decreased over the family's flight history (Falcon 9 + Heavy passed **656 launches by 2026-05-30**, with a single booster reaching a record **36th flight** in July 2026) compared to its early-2010s initial LHA sizing. For Starship, the AHA grew between IFT-4 and IFT-9 after the IFT-8 mishap increased conservative analysis inputs, then held across the V3 transition (Flight 12–13, 2026).

**Trend (2024–2026):** The FAA CSINAS ConOps (Commercial Space Integration into the National Airspace System) calls for progressive adoption of **Time-Based Launch Procedures** — shifting from blanket airspace closures to per-flight dynamic corridors keyed to the actual vehicle state. **Measured result (FAA, 2026):** Time-Based Procedures + dynamic windows have already cut the *mean airspace-closure duration* from **more than four hours to just over two hours per launch** — the first quantified payoff of the blanket-closure → dynamic-corridor shift, on the way to single-digit-minute diverts for nominal flights. This is now backed by a statutory deadline: the **FAA Reauthorization Act** requires NAS space-launch integration to be completed by **December 2026**, and full Part 450 applies to every launch/re-entry license from **2026-03-10**.

**A second, distinct instrument (2026-08) — the "priority corridor".** The dynamic-shrink trend above keeps the AHA and contracts it. **[NSPM-17](https://www.whitehouse.gov/presidential-actions/2026/08/national-security-presidential-memorandum-nspm-17/) (National Space Transportation Policy, 2026-08-20)** adds the opposite move: **designate *priority airspace for critical space launch corridors*** — pre-allocating standing sky-lanes to launch so that aviation routes *around* the corridor rather than the launch AHA being carved *out of* shared airspace per-event. The FAA opened **RFI Docket FAA-2026-9736** ("Siting New Spaceports and Use of Priority Airspace for Critical Space Launch Corridors", Fed. Reg. **2026-08-25**, comments due **2026-10-26**), paired with a DOT-led spaceport-siting effort (180-day deadline). The forcing function is cadence: NSPM-17 targets **1,000 launches+reentries/yr by 2030 → 10,000 FAA-licensed/yr by 2035** — a volume the dynamic-shrink loop alone may not absorb. For an AHA-tracking agent this means a future in which some corridors carry a **standing** hazard-area designation (not a per-launch NOTAM), so the "no NOTAM filed near NET = slip" heuristic ([[concepts/launch-window-slip]] §5) will need a corridor-status exception. The enclosure-vs-commons implications are in [[synthesis/space-launch-airspace-integration-six-region]] §"拉高維度 — priority corridors".
...
- **Europe:** published as **Temporary Danger Areas** by national ANSPs (e.g. SaxaVord/EGPX, Esrange/ESAA, Andøya/ENOR), pooled in [EUROCONTROL EAD](https://www.eurocontrol.int/service/european-ais-database); EASA/national flight-safety analysis rather than § 450.133. **Now validated end-to-end (2026-09-05):** Isar Aerospace Spectrum flight 2 reached orbit from Andøya (ENOR) — the first orbital launch from Western European soil — after the *same* danger-area auto-aborted its 2026-03-25 attempt when a vessel intruded; the Temporary-Danger-Area object behaves exactly like a US AHA (intrusion → abort) but is sized under national/EASA rules, not § 450.133 (see [[concepts/launch-window-slip]] §6a).
