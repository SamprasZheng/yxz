...
**Adoption reality (verified 2026-08-19).** The architectures have diverged by ~two orders of magnitude on adoption. DSNP's flagship is the [[entities/frequency]]/MeWe migration — the "over 1 million users" milestone (Amplica/MeWe PR, Aug-2024) resolves to **~1.3 M MeWe users migrated, ~600 K of them carrying full social graphs**, up from the 500 K announced Jan 2024 (MeWe appointed **Carlos Betancourt** CEO in 2025 to continue the Web3 push). Meanwhile the *federated/off-chain* rival — **AT Protocol / Bluesky** — reached **~46 M registered accounts (mid-2026)**; Bluesky does **not** officially publish MAU, but third-party trackers show active users that **peaked ~27.5 M (Feb 2026) then roughly halved to a mobile ~10.4 M MAU (June 2026, −27 % YoY, Similarweb via TechCrunch)** as the company pivots from the app to the AT-Protocol/"atmosphere" — still ~1–2 orders of magnitude above DSNP's migrated base, but **contracting rather than compounding.** So the "user-owned social at mass scale" question is now *answered* — but the market chose the **lighter portability model (DIDs/federation) over DSNP's harder L1-anchored-graph bet**, and even that winner's *flagship-app* engagement is now shrinking. DSNP's remaining edge is the *strength* of its portability guarantee (a chain-anchored graph is harder to reverse than a federated one), not its adoption. See the architecture-split table on [[synthesis/digital-democracy-user-owned-social-six-region]].
