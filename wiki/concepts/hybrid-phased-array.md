...
|---|---|---|---|
| Power amplifier (T/R front end) | **GaN-on-SiC** (high power density, efficiency), **GaN-on-Si** (cost-driven volume), GaAs (mature, lower power), LDMOS (sub-6 GHz) | GaN gives the highest W/mm and thermal headroom — now the default for radar and high-EIRP SATCOM | US (Qorvo, **[[entities/macom]]** — absorbed Wolfspeed's RF GaN 2023; runs both SiC + Si substrates), Korea (RFHIC), Taiwan ([[entities/win-semiconductors]] GaAs/GaN MMIC), France (UMS/OMMIC) |
...
This is why the **same hybrid array** can be a $100M defense radar (GaN-heavy, all-digital) or a sub-$1k consumer SATCOM terminal (SiGe beamformer, hybrid): the process mix, not the block diagram, sets the price. **The PA layer itself now bifurcates by substrate** (verified 2026-09-19): **GaN-on-SiC** keeps the high-power/high-EIRP/radar/space tier (2–4 W/mm at Ka-band, SiC's ~3× thermal-conductivity headroom over Si), while **GaN-on-Si** — ~2× cheaper on standard 8-inch Si wafers but power-density-limited — attacks the cost-dominated mmWave-volume end (5G massive-MIMO, cost-sensitive flat-panel terminals; 0.1 µm GaN-on-Si at 24–30 GHz in active development, notably in China for 5G scale). Merchant IDMs like [[entities/macom]] now run *both* substrates and pick per application. Full six-region treatment of the substrate split in [[synthesis/phased-array-rf-frontend-supply-chain]]. Market context: the SATCOM beamforming-IC segment was sized ≈ USD 2.87–4.3B in 2025–26 (source estimates diverge; ~10–19% CAGR toward the mid-2030s), driven by LEO flat-panel volume. The 2025–26 silicon-beamformer trend is explicit power reduction — Qorvo's Ku-band AWMF-0240/0241 ICs (2025-03) cut terminal power up to 25% (Tx) / 14% (Rx) — while the binding constraint upstream is **GaN-on-SiC capacity**: US RF foundries ran ~80–90% utilization with 20–35-week lead times in 2026 (re-verified 2026-07-24). See [[synthesis/phased-array-rf-frontend-supply-chain]] for the full six-region map and dated citations.
...
## Sources (accessed 2026-05-31; market + Taiwan-terminal refresh 2026-07-24; US GaN-vendor consolidation 2026-08-30; GaN substrate split 2026-09-19)
...
- GaN-on-SiC vs GaN-on-Si substrate split (SiC ~3× Si thermal conductivity; GaN-on-Si ~2× cheaper on 8-inch Si; 2–4 W/mm Ka-band; Chinese 0.1 µm 24–30 GHz GaN-on-Si for 5G volume): [PatSnap Eureka — GaN-on-SiC vs GaN-on-Si RF PAs](https://www.patsnap.com/resources/blog/rd-blog/gan-on-sic-vs-gan-on-si-rf-power-amplifiers-patsnap-eureka/); MACOM runs both substrates for SATCOM/A&D — [MACOM IMS 2026 SATCOM announcements](https://www.macom.com/updates/news/2026/macom-ims-2026-product-announcements-for-satellite-communication)
