...
- **V-JEPA / I-JEPA** (Meta AI, 2023–2025): video and image variants demonstrating "rudimentary intuitive physics" from self-supervised latent prediction. **V-JEPA 2** (Meta, released 2025-06-11; verified 2026-07-07) is the milestone that matters for the SDA thesis: a 1.2B-parameter *world model* trained on >1M hours of video that supports **zero-shot robot planning** from only ~62 hours of robot-control data, reportedly ~30× faster at inference than NVIDIA's Cosmos, shipped with new physical-reasoning benchmarks (IntPhys 2, CausalVQA, a shortcut-aware video-QA set). The significance: JEPA has crossed from "representation-learning objective" to a *deployed planning-capable world model* — the exact capability an orbital PoL predictor needs (learn the latent dynamics, forecast the expected next state, flag deviations). (Correction 2026-07-07: an earlier draft cited a "V-JEPA 2.1, March 2026" release — no such release is confirmed; the verified artifact is V-JEPA 2, June 2025.)
...
**Deployment-status refresh (verified 2026-07-07):** the September-2025 award is more precisely a **Direct-to-Phase-II SBIR, ~$1.2M over 18 months**, originated by the DoD **Chief Digital and Artificial Intelligence Office (CDAO)**, competitively selected by the **Office of the Secretary of Defense**, and executed by the **Air Force Digital Transformation Office** — i.e. a cross-office CDAO/OSD/AF-DTO vehicle, not a plain AFRL SBIR. It builds on a prior Space Force contract (**FA864923P1191**, AFRL/RVSX "DRAGON Army"). The operationally significant new datapoint: OrbitGuard gave a **live demonstration at the SDA TAP Lab's Apollo Project Demo Day, Colorado Springs, 2025-08-13**, showing autonomous integration with **KeepTrack** for tracking/analysis/visualization — the first public evidence of the JEPA+MARL stack running against a live tasking loop rather than a lab replay. The headline accuracy is best cited as **~94–96% maneuver-detection (self-reported, lab-validated)**; the "across ~15,000 objects" and "94–98%" phrasings both trace to the same press cycle and should not be read as independent results. The SDA TAP Lab pathway also ties MSBAI into the government-anchored commercial market mapped in [[synthesis/commercial-space-traffic-management-six-region]].
